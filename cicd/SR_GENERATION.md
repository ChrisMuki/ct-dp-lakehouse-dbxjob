...
It does **not** describe Databricks Asset Bundle assembly or deployment. For deployment-related behavior, see [cicd/SR_WORKFLOW_BUILDER.md](./SR_WORKFLOW_BUILDER.md).
...
Implementation: [cicd/src/main/scala/ct/dna/lakehouse/core/GenerateSrRaw.scala](./src/main/scala/ct/dna/lakehouse/core/GenerateSrRaw.scala)

### Purpose

`GenerateSrRaw` connects to the configured lakehouse environment, discovers the physical catalog structure, reads Unity table descriptions, and generates Scala source files under `lakehouse/src/main/scala/ct/dna/lakehouse/catalog/sr_raw`.

### Inputs

Primary runtime config: [cicd/src/main/resources/generate_sr_raw.json](./src/main/resources/generate_sr_raw.json)

Template: [cicd/src/main/resources/generate_sr_raw.json.template](./src/main/resources/generate_sr_raw.json.template)
...
```text
lakehouse/src/main/scala/ct/dna/lakehouse/catalog/sr_raw/
  package.scala
  <schema>/
    package.scala
    <table>.scala
...
Representative file: [lakehouse/src/main/scala/ct/dna/lakehouse/catalog/sr_raw/ct_gbl_p12/a017.scala](../lakehouse/src/main/scala/ct/dna/lakehouse/catalog/sr_raw/ct_gbl_p12/a017.scala)
...
Implementation: [cicd/src/main/scala/ct/dna/lakehouse/core/GenerateSr.scala](./src/main/scala/ct/dna/lakehouse/core/GenerateSr.scala)

Builder: [cicd/src/main/scala/ct/dna/lakehouse/core/modelbuilder/ChangeKeyTableSpecAstBuilder.scala](./src/main/scala/ct/dna/lakehouse/core/modelbuilder/ChangeKeyTableSpecAstBuilder.scala)

Model types: [cicd/src/main/scala/ct/dna/lakehouse/core/jobs/SrTableModel.scala](./src/main/scala/ct/dna/lakehouse/core/jobs/SrTableModel.scala)
...
Primary runtime config: [cicd/src/main/resources/generate_sr.json](./src/main/resources/generate_sr.json)

Template: [cicd/src/main/resources/generate_sr.json.template](./src/main/resources/generate_sr.json.template)
...
```bash
sbt "cicd/runMain ct.dna.lakehouse.core.GenerateSr baseDir=/workspaces/dp-lakehouse-dbxjob/lakehouse/src/main/scala/ct/dna/lakehouse/catalog/sr basePackage=ct.dna.lakehouse.sr srTableDefPath=/workspaces/dp-lakehouse-dbxjob/resources/sr/sr_table_def.json srRawBaseDir=/workspaces/dp-lakehouse-dbxjob/lakehouse/src/main/scala/ct/dna/lakehouse/catalog/sr_raw filterSchema=CT_GBL_P12 filterTable=A017"
```
...
```bash
sbt --batch -Dsbt.supershell=false cicd/compile
sbt --batch -Dsbt.supershell=false "cicd/testOnly ct.dna.lakehouse.core.GenerateSrProcessTest"
```

The focused SR-generation tests currently live in:

- [cicd/src/test/scala/ct/dna/lakehouse/core/GenerateSrProcessTest.scala](./src/test/scala/ct/dna/lakehouse/core/GenerateSrProcessTest.scala)
