...
case class E_marc_part1(
    ...
    @Decimal(3, 0) zvap_decimal_3_0: BigDecimal,
    @Decimal(11, 2) losfx_decimal_11_2: BigDecimal,
    @Decimal(13, 3) zmin_ord_decimal_13_3: BigDecimal,
    ...
    zbsc_region_string: String,
    @Decimal(13, 3) zstdpkqty_decimal_13_3: BigDecimal,
    ahdis_string: String,
    mtvfp_string: String,
    herbl_string: String,
...
case class E_marc_part2(
    ...
    zbsc_segment_string: String,
    @Decimal(5, 2) ausss_decimal_5_2: BigDecimal,
    zsort2_string: String,
    ...
    mogru_string: String,
    @Decimal(13, 3) zordintr_decimal_13_3: BigDecimal,
...
sealed class C_marc(prefix: String) extends ColumnWithNameAccessor {
  ...
  val zistka_string: ColumnWithName = ColumnWithName(prefix + "zistka_string")
  ...
  val zbsc_mtart_string: ColumnWithName = ColumnWithName(prefix + "zbsc_mtart_string")
  ...
  val zbsc_freq_string: ColumnWithName = ColumnWithName(prefix + "zbsc_freq_string")
  ...
  val zpgew_decimal_13_3: ColumnWithName = ColumnWithName(prefix + "zpgew_decimal_13_3")
  ...
  val zplantpn_string: ColumnWithName = ColumnWithName(prefix + "zplantpn_string")
  ...
  val zprodsts_string: ColumnWithName = ColumnWithName(prefix + "zprodsts_string")
  ...
  val zstdpkuom_string: ColumnWithName = ColumnWithName(prefix + "zstdpkuom_string")
  ...
  val zmm_maabc_mix_string: ColumnWithName = ColumnWithName(prefix + "zmm_maabc_mix_string")
  ...
  val zbsc_plant_string: ColumnWithName = ColumnWithName(prefix + "zbsc_plant_string")
  ...
  val zpickstrg_string: ColumnWithName = ColumnWithName(prefix + "zpickstrg_string")
  ...
  val zvap_decimal_3_0: ColumnWithName = ColumnWithName(prefix + "zvap_decimal_3_0")
  val losfx_decimal_11_2: ColumnWithName = ColumnWithName(prefix + "losfx_decimal_11_2")
  val zmin_ord_decimal_13_3: ColumnWithName = ColumnWithName(prefix + "zmin_ord_decimal_13_3")
  ...
  val zbsc_region_string: ColumnWithName = ColumnWithName(prefix + "zbsc_region_string")
  val zstdpkqty_decimal_13_3: ColumnWithName = ColumnWithName(prefix + "zstdpkqty_decimal_13_3")
  ...
  val zstoreclass_string: ColumnWithName = ColumnWithName(prefix + "zstoreclass_string")
  ...
  val zmm_maabc_con_string: ColumnWithName = ColumnWithName(prefix + "zmm_maabc_con_string")
  ...
  val zbsc_plc_string: ColumnWithName = ColumnWithName(prefix + "zbsc_plc_string")
  ...
  val zsort1_string: ColumnWithName = ColumnWithName(prefix + "zsort1_string")
  ...
  val zmina_string: ColumnWithName = ColumnWithName(prefix + "zmina_string")
  ...
  val zvmenge_string: ColumnWithName = ColumnWithName(prefix + "zvmenge_string")
  ...
  val zbsc_segment_string: ColumnWithName = ColumnWithName(prefix + "zbsc_segment_string")
  val ausss_decimal_5_2: ColumnWithName = ColumnWithName(prefix + "ausss_decimal_5_2")
  val zsort2_string: ColumnWithName = ColumnWithName(prefix + "zsort2_string")
  ...
  val zordintr_decimal_13_3: ColumnWithName = ColumnWithName(prefix + "zordintr_decimal_13_3")
  ...
  val zgebnr_string: ColumnWithName = ColumnWithName(prefix + "zgebnr_string")
