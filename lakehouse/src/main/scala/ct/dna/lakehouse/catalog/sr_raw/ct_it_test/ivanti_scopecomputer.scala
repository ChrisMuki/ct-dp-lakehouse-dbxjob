...
case class E_ivanti_scopecomputer(
    @PK _mk_org: String,
    @PK _mk_site: String,
...
object ivanti_scopecomputer extends TableSpec[E_ivanti_scopecomputer](enableChangeDataFeed = true, manualClusterBy = None, timetravelDays = 35) with Loaded
...
sealed class C_ivanti_scopecomputer(prefix: String) extends ColumnWithNameAccessor {
...
object C_ivanti_scopecomputer extends C_ivanti_scopecomputer("") {
  def as(alias: String): C_ivanti_scopecomputer = new C_ivanti_scopecomputer(alias + ".")
}
