...
case class E_mara_part1(
    ...
    zzctmat_string: String,
    color_string: String,
    rbnrm_string: String,
    medium_string: String,
    mfrpn_string: String,
    kzrev_string: String,
    zmatz_tx_string: String,
...
sealed class C_mara(prefix: String) extends ColumnWithNameAccessor {
  ...
  val zzctmat_string: ColumnWithName = ColumnWithName(prefix + "zzctmat_string")
  ...
  val zmatz_tx_string: ColumnWithName = ColumnWithName(prefix + "zmatz_tx_string")
  ...
  val zmatz_string: ColumnWithName = ColumnWithName(prefix + "zmatz_string")
  ...
  val zmatz_kl_string: ColumnWithName = ColumnWithName(prefix + "zmatz_kl_string")
