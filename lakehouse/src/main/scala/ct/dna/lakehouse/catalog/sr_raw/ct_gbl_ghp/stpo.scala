...
case class E_stpo(
    ...
    potx1_string: String,
    dvnam_string: String,
    preliminary_material_string: String,
    prvbe_string: String,
    alpgr_string: String,
    ...
    vackz_string: String,
    itmid_string: String,
    servicedurationunit_string: String,
    mandt_string: String,
    ...
    ydiau_string: String,
    aehlp_string: String,
    @Decimal(5, 1) serviceduration_decimal_5_1: BigDecimal,
...
sealed class C_stpo(prefix: String) extends ColumnWithNameAccessor {
  ...
  val preliminary_material_string: ColumnWithName = ColumnWithName(prefix + "preliminary_material_string")
  ...
  val servicedurationunit_string: ColumnWithName = ColumnWithName(prefix + "servicedurationunit_string")
  ...
  val serviceduration_decimal_5_1: ColumnWithName = ColumnWithName(prefix + "serviceduration_decimal_5_1")
