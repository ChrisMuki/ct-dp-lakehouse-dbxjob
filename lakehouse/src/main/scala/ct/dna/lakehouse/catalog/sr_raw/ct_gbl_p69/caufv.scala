...
object caufv extends TableSpec[Joined[E_caufv_part1, E_caufv_part2]](enableChangeDataFeed = true, manualClusterBy = None, timetravelDays = 35) with Loaded
...
sealed class C_caufv(prefix: String) extends ColumnWithNameAccessor {
...
object C_caufv extends C_caufv("") {
  def as(alias: String): C_caufv = new C_caufv(alias + ".")
}
