...
case class E_ivanti_consoleusergroup(
    @PK _mk_org: String,
    @PK _mk_site: String,
...
object ivanti_consoleusergroup
    extends TableSpec[E_ivanti_consoleusergroup](enableChangeDataFeed = true, manualClusterBy = None, timetravelDays = 35)
    with Loaded
...
sealed class C_ivanti_consoleusergroup(prefix: String) extends ColumnWithNameAccessor {
...
object C_ivanti_consoleusergroup extends C_ivanti_consoleusergroup("") {
  def as(alias: String): C_ivanti_consoleusergroup = new C_ivanti_consoleusergroup(alias + ".")
}
