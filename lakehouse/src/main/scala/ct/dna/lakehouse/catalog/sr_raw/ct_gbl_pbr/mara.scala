...
case class E_mara_part1(
    ...
    size1_string: String,
    tragr_string: String,
    zzqsys_string: String,
    inhme_string: String,
    xgchp_string: String,
    tare_var_string: String,
    magrv_string: String,
    vpsta_string: String,
    zzuzeit_string: String,
    rdmhd_string: String,
    mstdv_date: Date,
    begru_string: String,
    rmatp_string: String,
    ...
    zzexsys_string: String,
    color_string: String,
    zzmtart_string: String,
    zzmtart2_string: String,
    zzmeineti_string: String,
    rbnrm_string: String,
    zzfrve_string: String,
    ...
    bmatn_string: String,
    zzdatfr_date: Date,
    zzloin_string: String,
    bstme_string: String,
    fsh_sc_mid_string: String,
    zzvdomatnr_string: String,
    kzeff_string: String,
    nrfhg_string: String,
    bbtyp_string: String,
    zeifo_string: String,
...
sealed class C_mara(prefix: String) extends ColumnWithNameAccessor {
  ...
  val zzqsys_string: ColumnWithName = ColumnWithName(prefix + "zzqsys_string")
  ...
  val zzuzeit_string: ColumnWithName = ColumnWithName(prefix + "zzuzeit_string")
  ...
  val zzsrc_string: ColumnWithName = ColumnWithName(prefix + "zzsrc_string")
  ...
  val zzfnr1_string: ColumnWithName = ColumnWithName(prefix + "zzfnr1_string")
  ...
  val zzverfk_string: ColumnWithName = ColumnWithName(prefix + "zzverfk_string")
  ...
  val zztemnr_string: ColumnWithName = ColumnWithName(prefix + "zztemnr_string")
  ...
  val zzaemk2_string: ColumnWithName = ColumnWithName(prefix + "zzaemk2_string")
  val groes_string: ColumnWithName = ColumnWithName(prefix + "groes_string")
  val zzprodfam_string: ColumnWithName = ColumnWithName(prefix + "zzprodfam_string")
  ...
  val zzson_string: ColumnWithName = ColumnWithName(prefix + "zzson_string")
  ...
  val zzexsys_string: ColumnWithName = ColumnWithName(prefix + "zzexsys_string")
  val color_string: ColumnWithName = ColumnWithName(prefix + "color_string")
  val zzmtart_string: ColumnWithName = ColumnWithName(prefix + "zzmtart_string")
  val zzmtart2_string: ColumnWithName = ColumnWithName(prefix + "zzmtart2_string")
  val zzmeineti_string: ColumnWithName = ColumnWithName(prefix + "zzmeineti_string")
  val rbnrm_string: ColumnWithName = ColumnWithName(prefix + "rbnrm_string")
  val zzfrve_string: ColumnWithName = ColumnWithName(prefix + "zzfrve_string")
  ...
  val zzhts_string: ColumnWithName = ColumnWithName(prefix + "zzhts_string")
  ...
  val zzaeve_string: ColumnWithName = ColumnWithName(prefix + "zzaeve_string")
  ...
  val zzdatum_date: ColumnWithName = ColumnWithName(prefix + "zzdatum_date")
  ...
  val zzaeikm_string: ColumnWithName = ColumnWithName(prefix + "zzaeikm_string")
  ...
  val zzlote_string: ColumnWithName = ColumnWithName(prefix + "zzlote_string")
  val datab_date: ColumnWithName = ColumnWithName(prefix + "datab_date")
  val zmodc_string: ColumnWithName = ColumnWithName(prefix + "zmodc_string")
  ...
  val zzdatla_date: ColumnWithName = ColumnWithName(prefix + "zzdatla_date")
  ...
  val zzobart_string: ColumnWithName = ColumnWithName(prefix + "zzobart_string")
  ...
  val zzplannsnp_string: ColumnWithName = ColumnWithName(prefix + "zzplannsnp_string")
  ...
  val zzerror_string: ColumnWithName = ColumnWithName(prefix + "zzerror_string")
  ...
  val zzfnr2_string: ColumnWithName = ColumnWithName(prefix + "zzfnr2_string")
  ...
  val zzaeik_string: ColumnWithName = ColumnWithName(prefix + "zzaeik_string")
  ...
  val zzdatfr_date: ColumnWithName = ColumnWithName(prefix + "zzdatfr_date")
  val zzloin_string: ColumnWithName = ColumnWithName(prefix + "zzloin_string")
  ...
  val zzvdomatnr_string: ColumnWithName = ColumnWithName(prefix + "zzvdomatnr_string")
  ...
  val zzwkstn_string: ColumnWithName = ColumnWithName(prefix + "zzwkstn_string")
  ...
  val zzaemk1_string: ColumnWithName = ColumnWithName(prefix + "zzaemk1_string")
  ...
  val zzdoktl_string: ColumnWithName = ColumnWithName(prefix + "zzdoktl_string")
  ...
  val zzdatla_string: ColumnWithName = ColumnWithName(prefix + "zzdatla_string")
  ...
  val zzdatum_string: ColumnWithName = ColumnWithName(prefix + "zzdatum_string")
  val mstde_string: ColumnWithName = ColumnWithName(prefix + "mstde_string")
  val zzdatfr_string: ColumnWithName = ColumnWithName(prefix + "zzdatfr_string")
