...
sealed class C_marc(prefix: String) extends ColumnWithNameAccessor {
  ...
  val zz_shelf_life_h_string: ColumnWithName = ColumnWithName(prefix + "zz_shelf_life_h_string")
  ...
  val zz_testprofile_string: ColumnWithName = ColumnWithName(prefix + "zz_testprofile_string")
  ...
  val zz_oldmatnr_string: ColumnWithName = ColumnWithName(prefix + "zz_oldmatnr_string")
  ...
  val zz_custmatnum_string: ColumnWithName = ColumnWithName(prefix + "zz_custmatnum_string")
  ...
  val zz_prioritynum_string: ColumnWithName = ColumnWithName(prefix + "zz_prioritynum_string")
  ...
  val zz_productresp_string: ColumnWithName = ColumnWithName(prefix + "zz_productresp_string")
  val zz_hdate_string: ColumnWithName = ColumnWithName(prefix + "zz_hdate_string")
