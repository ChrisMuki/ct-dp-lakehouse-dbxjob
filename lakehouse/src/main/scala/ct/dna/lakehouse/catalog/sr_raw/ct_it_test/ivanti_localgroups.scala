...
case class E_ivanti_localgroups(
    @PK _mk_org: String,
    @PK _mk_site: String,
...
object ivanti_localgroups extends TableSpec[E_ivanti_localgroups](enableChangeDataFeed = true, manualClusterBy = None, timetravelDays = 35) with Loaded
...
sealed class C_ivanti_localgroups(prefix: String) extends ColumnWithNameAccessor {
...
object C_ivanti_localgroups extends C_ivanti_localgroups("") {
  def as(alias: String): C_ivanti_localgroups = new C_ivanti_localgroups(alias + ".")
}
