...
case class E_marc_part1(
    ...
    rgekz_string: String,
    atpkz_string: String,
    @Decimal(3, 0) zzrw_max_decimal_3_0: BigDecimal,
    ...
    autru_string: String,
    kzppv_string: String,
    @Decimal(7, 0) zzrw_ist_decimal_7_0: BigDecimal,
    ...
    fxpru_string: String,
    ekgrp_string: String,
    @Decimal(3, 0) zzrw_min_decimal_3_0: BigDecimal,
    ...
    @Decimal(13, 3) zzlb_max_decimal_13_3: BigDecimal,
    ...
    mtver_string: String,
    herkl_string: String,
    @Decimal(13, 3) zzlb_min_decimal_13_3: BigDecimal,
...
sealed class C_marc(prefix: String) extends ColumnWithNameAccessor {
  ...
  val zzrw_max_decimal_3_0: ColumnWithName = ColumnWithName(prefix + "zzrw_max_decimal_3_0")
  ...
  val zzrw_ist_decimal_7_0: ColumnWithName = ColumnWithName(prefix + "zzrw_ist_decimal_7_0")
  ...
  val zzrw_istdat_string: ColumnWithName = ColumnWithName(prefix + "zzrw_istdat_string")
  ...
  val zzrw_min_decimal_3_0: ColumnWithName = ColumnWithName(prefix + "zzrw_min_decimal_3_0")
  ...
  val zzlb_max_decimal_13_3: ColumnWithName = ColumnWithName(prefix + "zzlb_max_decimal_13_3")
  ...
  val zzlb_min_decimal_13_3: ColumnWithName = ColumnWithName(prefix + "zzlb_min_decimal_13_3")
