...
case class E_stpo(
    ...
    rfpnt_string: String,
    zznormt_string: String,
    valid_to_string: String,
    zzbcskey_string: String,
    ...
    aedat_string: String,
    zzmfrpn_string: String,
    zzlvorm_mara_string: String,
    sanfe_string: String,
...
sealed class C_stpo(prefix: String) extends ColumnWithNameAccessor {
  ...
  val zzhkm_string: ColumnWithName = ColumnWithName(prefix + "zzhkm_string")
  ...
  val zzaen_string: ColumnWithName = ColumnWithName(prefix + "zzaen_string")
  ...
  val zzhkp_string: ColumnWithName = ColumnWithName(prefix + "zzhkp_string")
  ...
  val zztestprof_string: ColumnWithName = ColumnWithName(prefix + "zztestprof_string")
  ...
  val zzwrkst_string: ColumnWithName = ColumnWithName(prefix + "zzwrkst_string")
  ...
  val zzlvorm_marc_string: ColumnWithName = ColumnWithName(prefix + "zzlvorm_marc_string")
  ...
  val zzamp2_string: ColumnWithName = ColumnWithName(prefix + "zzamp2_string")
  ...
  val zzaip_string: ColumnWithName = ColumnWithName(prefix + "zzaip_string")
  val zzvfp_string: ColumnWithName = ColumnWithName(prefix + "zzvfp_string")
  ...
  val zznormt_string: ColumnWithName = ColumnWithName(prefix + "zznormt_string")
  val valid_to_string: ColumnWithName = ColumnWithName(prefix + "valid_to_string")
  val zzbcskey_string: ColumnWithName = ColumnWithName(prefix + "zzbcskey_string")
  ...
  val zzmfrpn_string: ColumnWithName = ColumnWithName(prefix + "zzmfrpn_string")
  val zzlvorm_mara_string: ColumnWithName = ColumnWithName(prefix + "zzlvorm_mara_string")
  ...
  val zzamp1_string: ColumnWithName = ColumnWithName(prefix + "zzamp1_string")
  ...
  val zzgroes_string: ColumnWithName = ColumnWithName(prefix + "zzgroes_string")
