...
sealed class C_mara(prefix: String) extends ColumnWithNameAccessor {
  ...
  val zkrefer_string: ColumnWithName = ColumnWithName(prefix + "zkrefer_string")
  ...
  val zkerdat_date: ColumnWithName = ColumnWithName(prefix + "zkerdat_date")
  ...
  val zkerzet_string: ColumnWithName = ColumnWithName(prefix + "zkerzet_string")
  ...
  val zkfreig1_string: ColumnWithName = ColumnWithName(prefix + "zkfreig1_string")
  ...
  val zkerdat_string: ColumnWithName = ColumnWithName(prefix + "zkerdat_string")
