...
sealed class C_ekko(prefix: String) extends ColumnWithNameAccessor {
  ...
  val distributiontype_string: ColumnWithName = ColumnWithName(prefix + "distributiontype_string")
  ...
  val process_indicator_string: ColumnWithName = ColumnWithName(prefix + "process_indicator_string")
  ...
  val cont_string: ColumnWithName = ColumnWithName(prefix + "cont_string")
  ...
  val pare_dat_string: ColumnWithName = ColumnWithName(prefix + "pare_dat_string")
  val dummy_ekko_incl_eew_ps_string: ColumnWithName = ColumnWithName(prefix + "dummy_ekko_incl_eew_ps_string")
  val eq_eindt_string: ColumnWithName = ColumnWithName(prefix + "eq_eindt_string")
  val outr_string: ColumnWithName = ColumnWithName(prefix + "outr_string")
  ...
  val has_catalog_relevant_items_string: ColumnWithName = ColumnWithName(prefix + "has_catalog_relevant_items_string")
  ...
  val desp_cargo_string: ColumnWithName = ColumnWithName(prefix + "desp_cargo_string")
  ...
  val conc_string: ColumnWithName = ColumnWithName(prefix + "conc_string")
  ...
  val pare_string: ColumnWithName = ColumnWithName(prefix + "pare_string")
  val proce_string: ColumnWithName = ColumnWithName(prefix + "proce_string")
  val isaged_string: ColumnWithName = ColumnWithName(prefix + "isaged_string")
  val grouping_id_string: ColumnWithName = ColumnWithName(prefix + "grouping_id_string")
  ...
  val pfm_contract_string: ColumnWithName = ColumnWithName(prefix + "pfm_contract_string")
  val kalsm_string: ColumnWithName = ColumnWithName(prefix + "kalsm_string")
  val total_status_pcs_string: ColumnWithName = ColumnWithName(prefix + "total_status_pcs_string")
  val comp_string: ColumnWithName = ColumnWithName(prefix + "comp_string")
  ...
  val total_status_sds_string: ColumnWithName = ColumnWithName(prefix + "total_status_sds_string")
  val followon_doc_cat_string: ColumnWithName = ColumnWithName(prefix + "followon_doc_cat_string")
  ...
  val followon_doc_type_string: ColumnWithName = ColumnWithName(prefix + "followon_doc_type_string")
  ...
  val desp_dat_string: ColumnWithName = ColumnWithName(prefix + "desp_dat_string")
  ...
  val cr_stat_string: ColumnWithName = ColumnWithName(prefix + "cr_stat_string")
  ...
  val total_status_pma_string: ColumnWithName = ColumnWithName(prefix + "total_status_pma_string")
  ...
  val active_id_string: ColumnWithName = ColumnWithName(prefix + "active_id_string")
  ...
  val desp_string: ColumnWithName = ColumnWithName(prefix + "desp_string")
  ...
  val total_status_dg_string: ColumnWithName = ColumnWithName(prefix + "total_status_dg_string")
  ...
  val pare_cargo_string: ColumnWithName = ColumnWithName(prefix + "pare_cargo_string")
  val qtn_erlst_submsn_date_string: ColumnWithName = ColumnWithName(prefix + "qtn_erlst_submsn_date_string")
