...
sealed class C_bsak(prefix: String) extends ColumnWithNameAccessor {
  ...
  val sknto_decimal_23_2: ColumnWithName = ColumnWithName(prefix + "sknto_decimal_23_2")
  val dmbtr_decimal_23_2: ColumnWithName = ColumnWithName(prefix + "dmbtr_decimal_23_2")
  val rebzt_string: ColumnWithName = ColumnWithName(prefix + "rebzt_string")
  val qsshb_decimal_23_2: ColumnWithName = ColumnWithName(prefix + "qsshb_decimal_23_2")
  ...
  val bukrs_sender_string: ColumnWithName = ColumnWithName(prefix + "bukrs_sender_string")
  ...
  val kzbtr_decimal_23_2: ColumnWithName = ColumnWithName(prefix + "kzbtr_decimal_23_2")
  ...
  val txdat_from2_string: ColumnWithName = ColumnWithName(prefix + "txdat_from2_string")
  ...
  val tax_country1_string: ColumnWithName = ColumnWithName(prefix + "tax_country1_string")
  ...
  val bdif2_decimal_23_2: ColumnWithName = ColumnWithName(prefix + "bdif2_decimal_23_2")
  val gkont_string: ColumnWithName = ColumnWithName(prefix + "gkont_string")
  val qbshb_decimal_23_2: ColumnWithName = ColumnWithName(prefix + "qbshb_decimal_23_2")
  ...
  val dmbt3_decimal_23_2: ColumnWithName = ColumnWithName(prefix + "dmbt3_decimal_23_2")
  ...
  val dmbt2_decimal_23_2: ColumnWithName = ColumnWithName(prefix + "dmbt2_decimal_23_2")
  val rfccur_string: ColumnWithName = ColumnWithName(prefix + "rfccur_string")
  val mwsts_decimal_23_2: ColumnWithName = ColumnWithName(prefix + "mwsts_decimal_23_2")
  ...
  val pswbt_decimal_23_2: ColumnWithName = ColumnWithName(prefix + "pswbt_decimal_23_2")
  ...
  val dmbt1_decimal_23_2: ColumnWithName = ColumnWithName(prefix + "dmbt1_decimal_23_2")
  val tax_country2_string: ColumnWithName = ColumnWithName(prefix + "tax_country2_string")
  val dmb21_decimal_23_2: ColumnWithName = ColumnWithName(prefix + "dmb21_decimal_23_2")
  val wrbtr_decimal_23_2: ColumnWithName = ColumnWithName(prefix + "wrbtr_decimal_23_2")
  ...
  val wmwst_decimal_23_2: ColumnWithName = ColumnWithName(prefix + "wmwst_decimal_23_2")
  ...
  val bdiff_decimal_23_2: ColumnWithName = ColumnWithName(prefix + "bdiff_decimal_23_2")
  ...
  val wrbt2_decimal_23_2: ColumnWithName = ColumnWithName(prefix + "wrbt2_decimal_23_2")
  ...
  val belnr_sender_string: ColumnWithName = ColumnWithName(prefix + "belnr_sender_string")
  val zbd3t_decimal_3_0: ColumnWithName = ColumnWithName(prefix + "zbd3t_decimal_3_0")
  val skfbt_decimal_23_2: ColumnWithName = ColumnWithName(prefix + "skfbt_decimal_23_2")
  ...
  val txdat_from1_string: ColumnWithName = ColumnWithName(prefix + "txdat_from1_string")
  ...
  val fcsl_decimal_23_2: ColumnWithName = ColumnWithName(prefix + "fcsl_decimal_23_2")
  ...
  val wrbt3_decimal_23_2: ColumnWithName = ColumnWithName(prefix + "wrbt3_decimal_23_2")
  ...
  val gjahr_sender_string: ColumnWithName = ColumnWithName(prefix + "gjahr_sender_string")
  ...
  val qsfbt_decimal_23_2: ColumnWithName = ColumnWithName(prefix + "qsfbt_decimal_23_2")
  val lwsts_decimal_23_2: ColumnWithName = ColumnWithName(prefix + "lwsts_decimal_23_2")
  ...
  val tax_country3_string: ColumnWithName = ColumnWithName(prefix + "tax_country3_string")
  ...
  val logsystem_sender_string: ColumnWithName = ColumnWithName(prefix + "logsystem_sender_string")
  ...
  val wrbt1_decimal_23_2: ColumnWithName = ColumnWithName(prefix + "wrbt1_decimal_23_2")
  ...
  val txdat_from3_string: ColumnWithName = ColumnWithName(prefix + "txdat_from3_string")
  ...
  val wskto_decimal_23_2: ColumnWithName = ColumnWithName(prefix + "wskto_decimal_23_2")
