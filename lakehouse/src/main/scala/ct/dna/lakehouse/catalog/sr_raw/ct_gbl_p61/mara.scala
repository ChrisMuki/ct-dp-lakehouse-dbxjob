...
case class E_mara_part1(
    ...
    cadkz_string: String,
    ekwsl_string: String,
    @Decimal(7, 2) zz_ld_decimal_7_2: BigDecimal,
    ...
    zz_rha_steuer_string: String,
    ervoe_string: String,
    zz_dimension_string: String,
    saiso_string: String,
    ...
    imatn_string: String,
    zz_info1_pl_string: String,
    fsh_mg_at2_string: String,
    nsnid_string: String,
    zztest_string: String,
    behvo_string: String,
    zz_quality_string: String,
    ...
    zz_teilung_string: String,
    xgrdt_string: String,
    fsh_mg_at3_string: String,
    przus_string: String,
    serlv_string: String,
    zz_vol_update_date: Date,
    cuobf_string: String,
    zzcpmgs_string: String,
    ...
    zz_schlagwort_string: String,
    ergei_string: String,
    kzwsm_string: String,
    eannr_string: String,
    zz_nfmat_string: String,
    pmata_string: String,
    extwg_string: String,
    ...
    @Decimal(7, 2) zz_breite_decimal_7_2: BigDecimal,
    profl_string: String,
    ...
    zz_rma_string: String,
    logunit_string: String,
    zz_zahnezahi_int: BoxedInt,
    vhart_string: String,
    ...
    @Decimal(7, 2) zz_inchlange_decimal_7_2: BigDecimal,
    mstde_date: Date,
    aeszn_string: String,
    ...
    zz_id_verpackung_string: String,
    matfi_string: String,
...
case class E_mara_part2(
    ...
    zz_mark_field_string: String,
    matkl_string: String,
    vtype_string: String,
    zz_project_string: String,
...
sealed class C_mara(prefix: String) extends ColumnWithNameAccessor {
  ...
  val zz_kordart_string: ColumnWithName = ColumnWithName(prefix + "zz_kordart_string")
  ...
  val zz_segment_string: ColumnWithName = ColumnWithName(prefix + "zz_segment_string")
  val ernam_string: ColumnWithName = ColumnWithName(prefix + "ernam_string")
  val zz_extern_dim_string: ColumnWithName = ColumnWithName(prefix + "zz_extern_dim_string")
  ...
  val zz_unit_group_string: ColumnWithName = ColumnWithName(prefix + "zz_unit_group_string")
  ...
  val zz_ld_decimal_7_2: ColumnWithName = ColumnWithName(prefix + "zz_ld_decimal_7_2")
  ...
  val zz_oe_matbarcode_string: ColumnWithName = ColumnWithName(prefix + "zz_oe_matbarcode_string")
  ...
  val zz_iso_string: ColumnWithName = ColumnWithName(prefix + "zz_iso_string")
  ...
  val zz_matnr_prod_string: ColumnWithName = ColumnWithName(prefix + "zz_matnr_prod_string")
  ...
  val zz_rha_steuer_string: ColumnWithName = ColumnWithName(prefix + "zz_rha_steuer_string")
  val ervoe_string: ColumnWithName = ColumnWithName(prefix + "ervoe_string")
  val zz_dimension_string: ColumnWithName = ColumnWithName(prefix + "zz_dimension_string")
  ...
  val zz_info1_pl_string: ColumnWithName = ColumnWithName(prefix + "zz_info1_pl_string")
  ...
  val zztest_string: ColumnWithName = ColumnWithName(prefix + "zztest_string")
  val behvo_string: ColumnWithName = ColumnWithName(prefix + "behvo_string")
  val zz_quality_string: ColumnWithName = ColumnWithName(prefix + "zz_quality_string")
  val zz_farbe_string: ColumnWithName = ColumnWithName(prefix + "zz_farbe_string")
  ...
  val zz_teilung_string: ColumnWithName = ColumnWithName(prefix + "zz_teilung_string")
  ...
  val zz_vol_update_date: ColumnWithName = ColumnWithName(prefix + "zz_vol_update_date")
  val cuobf_string: ColumnWithName = ColumnWithName(prefix + "cuobf_string")
  val zzcpmgs_string: ColumnWithName = ColumnWithName(prefix + "zzcpmgs_string")
  ...
  val zz_la_int: ColumnWithName = ColumnWithName(prefix + "zz_la_int")
  ...
  val zz_li_string: ColumnWithName = ColumnWithName(prefix + "zz_li_string")
  ...
  val zz_schlagwort_string: ColumnWithName = ColumnWithName(prefix + "zz_schlagwort_string")
  ...
  val zz_nfmat_string: ColumnWithName = ColumnWithName(prefix + "zz_nfmat_string")
  ...
  val zz_profil_string: ColumnWithName = ColumnWithName(prefix + "zz_profil_string")
  ...
  val zz_breite_decimal_7_2: ColumnWithName = ColumnWithName(prefix + "zz_breite_decimal_7_2")
  ...
  val zz_info2_pl_string: ColumnWithName = ColumnWithName(prefix + "zz_info2_pl_string")
  ...
  val zz_rma_string: ColumnWithName = ColumnWithName(prefix + "zz_rma_string")
  val logunit_string: ColumnWithName = ColumnWithName(prefix + "logunit_string")
  val zz_zahnezahi_int: ColumnWithName = ColumnWithName(prefix + "zz_zahnezahi_int")
  ...
  val zz_inchlange_decimal_7_2: ColumnWithName = ColumnWithName(prefix + "zz_inchlange_decimal_7_2")
  ...
  val zz_id_verpackung_string: ColumnWithName = ColumnWithName(prefix + "zz_id_verpackung_string")
  ...
  val zz_mark_field_string: ColumnWithName = ColumnWithName(prefix + "zz_mark_field_string")
  ...
  val zz_project_string: ColumnWithName = ColumnWithName(prefix + "zz_project_string")
  ...
  val zz_vol_update_string: ColumnWithName = ColumnWithName(prefix + "zz_vol_update_string")
