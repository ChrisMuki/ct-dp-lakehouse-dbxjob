...
case class E_marc_part1(
    ...
    @Decimal(5, 3) zz_dichte_decimal_5_3: BigDecimal,
    zz_shorehaerte_string: String,
    ocmpf_string: String,
    ...
    maabc_string: String,
    vrmod_string: String,
    zz_anlagenklasse_string: String,
...
sealed class C_marc(prefix: String) extends ColumnWithNameAccessor {
  ...
  val zz_dichte_decimal_5_3: ColumnWithName = ColumnWithName(prefix + "zz_dichte_decimal_5_3")
  val zz_shorehaerte_string: ColumnWithName = ColumnWithName(prefix + "zz_shorehaerte_string")
  ...
  val zz_anlagenklasse_string: ColumnWithName = ColumnWithName(prefix + "zz_anlagenklasse_string")
  ...
  val zz_liefer_abm_string: ColumnWithName = ColumnWithName(prefix + "zz_liefer_abm_string")
  ...
  val zz_polymertyp_string: ColumnWithName = ColumnWithName(prefix + "zz_polymertyp_string")
