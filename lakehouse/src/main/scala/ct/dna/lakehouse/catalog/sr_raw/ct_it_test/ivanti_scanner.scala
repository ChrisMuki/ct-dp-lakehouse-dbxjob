...
object ivanti_scanner extends TableSpec[E_ivanti_scanner](enableChangeDataFeed = true, manualClusterBy = None, timetravelDays = 35) with Loaded
...
sealed class C_ivanti_scanner(prefix: String) extends ColumnWithNameAccessor {
...
object C_ivanti_scanner extends C_ivanti_scanner("") {
  def as(alias: String): C_ivanti_scanner = new C_ivanti_scanner(alias + ".")
}
