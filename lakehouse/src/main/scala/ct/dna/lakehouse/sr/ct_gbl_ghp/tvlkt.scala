...
object tvlkt
    extends TableSpec[E_tvlkt](
      enableChangeDataFeed = true,
      clusterBy = ClusterBy.PRIMARY_KEY,
      timetravelDays = 35
    )
    with ChangeKey[sr_raw.ct_gbl_ghp.E_tvlkt] {
  override def sourceTableSpec: TableSpec[sr_raw.ct_gbl_ghp.E_tvlkt] = sr_raw.ct_gbl_ghp.tvlkt
...
sealed class C_tvlkt(prefix: String) extends ColumnWithNameAccessor {
...
object C_tvlkt extends C_tvlkt("") {
  def as(alias: String): C_tvlkt = new C_tvlkt(alias + ".")
}
