...
object t025
    extends TableSpec[E_t025](
      enableChangeDataFeed = true,
      clusterBy = ClusterBy.PRIMARY_KEY,
      timetravelDays = 35
    )
    with ChangeKey[sr_raw.ct_gbl_ghp.E_t025] {
  override def sourceTableSpec: TableSpec[sr_raw.ct_gbl_ghp.E_t025] = sr_raw.ct_gbl_ghp.t025
...
sealed class C_t025(prefix: String) extends ColumnWithNameAccessor {
...
object C_t025 extends C_t025("") {
  def as(alias: String): C_t025 = new C_t025(alias + ".")
}
