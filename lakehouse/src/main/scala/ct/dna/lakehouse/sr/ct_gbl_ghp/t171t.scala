...
object t171t
    extends TableSpec[E_t171t](
      enableChangeDataFeed = true,
      clusterBy = ClusterBy.PRIMARY_KEY,
      timetravelDays = 35
    )
    with ChangeKey[sr_raw.ct_gbl_ghp.E_t171t] {
  override def sourceTableSpec: TableSpec[sr_raw.ct_gbl_ghp.E_t171t] = sr_raw.ct_gbl_ghp.t171t
...
sealed class C_t171t(prefix: String) extends ColumnWithNameAccessor {
  ...
  val bztxt: ColumnWithName = ColumnWithName(prefix + "bztxt")
...
object C_t171t extends C_t171t("") {
  def as(alias: String): C_t171t = new C_t171t(alias + ".")
}
