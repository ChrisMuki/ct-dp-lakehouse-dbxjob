...
object tka02
    extends TableSpec[E_tka02](
      enableChangeDataFeed = true,
      clusterBy = ClusterBy.PRIMARY_KEY,
      timetravelDays = 35
    )
    with ChangeKey[sr_raw.ct_gbl_p24.E_tka02] {
  override def sourceTableSpec: TableSpec[sr_raw.ct_gbl_p24.E_tka02] = sr_raw.ct_gbl_p24.tka02
...
sealed class C_tka02(prefix: String) extends ColumnWithNameAccessor {
...
object C_tka02 extends C_tka02("") {
  def as(alias: String): C_tka02 = new C_tka02(alias + ".")
}
