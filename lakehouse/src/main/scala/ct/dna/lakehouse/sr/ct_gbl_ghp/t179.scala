...
object t179
    extends TableSpec[E_t179](
      enableChangeDataFeed = true,
      clusterBy = ClusterBy.PRIMARY_KEY,
      timetravelDays = 35
    )
    with ChangeKey[sr_raw.ct_gbl_ghp.E_t179] {
  override def sourceTableSpec: TableSpec[sr_raw.ct_gbl_ghp.E_t179] = sr_raw.ct_gbl_ghp.t179
...
sealed class C_t179(prefix: String) extends ColumnWithNameAccessor {
...
object C_t179 extends C_t179("") {
  def as(alias: String): C_t179 = new C_t179(alias + ".")
}
