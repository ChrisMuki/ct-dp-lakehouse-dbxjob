...
import ct.dna.lakehouse.sr_raw.ct_gbl_e32.{stko => sr_raw_stko}
...
object stko extends TableSpec[SrStko] with ChangeKey[ct.dna.lakehouse.sr_raw.ct_gbl_e32.E_stko] {

  override def sourceTableSpec: TableSpec[ct.dna.lakehouse.sr_raw.ct_gbl_e32.E_stko] = sr_raw_stko
