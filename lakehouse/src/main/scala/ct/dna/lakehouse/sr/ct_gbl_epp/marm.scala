...
import ct.dna.lakehouse.sr_raw.ct_gbl_epp.{marm => sr_raw_marm}
...
object marm extends TableSpec[SrMarm] with ChangeKey[ct.dna.lakehouse.sr_raw.ct_gbl_epp.E_marm] {

  override def sourceTableSpec: TableSpec[ct.dna.lakehouse.sr_raw.ct_gbl_epp.E_marm] = sr_raw_marm
