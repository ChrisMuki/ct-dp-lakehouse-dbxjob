...
object tcurf
    ...
    with ChangeKey[sr_raw.ct_gbl_ghp.E_tcurf] {
  override def sourceTableSpec: TableSpec[sr_raw.ct_gbl_ghp.E_tcurf] = sr_raw.ct_gbl_ghp.tcurf
  ...
  override def preApplyMapping: Seq[(String, Column)] = Seq(
    ...
    ("abwct", col("abwct_string")),
    ("abwga", col("abwga_string"))
  )
}
...
sealed class C_tcurf(prefix: String) extends ColumnWithNameAccessor {
  ...
  val abwct: ColumnWithName = ColumnWithName(prefix + "abwct")
  val abwga: ColumnWithName = ColumnWithName(prefix + "abwga")
