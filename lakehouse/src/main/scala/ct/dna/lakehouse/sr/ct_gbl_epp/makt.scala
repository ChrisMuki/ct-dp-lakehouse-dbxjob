...
import ct.dna.lakehouse.sr_raw.ct_gbl_epp.{makt => sr_raw_makt}
...
object makt extends TableSpec[SrMakt] with ChangeKey[ct.dna.lakehouse.sr_raw.ct_gbl_epp.E_makt] {

  override def sourceTableSpec: TableSpec[ct.dna.lakehouse.sr_raw.ct_gbl_epp.E_makt] = sr_raw_makt
