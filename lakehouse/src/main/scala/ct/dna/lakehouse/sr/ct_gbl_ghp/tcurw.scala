...
object tcurw
    extends TableSpec[E_tcurw](
      enableChangeDataFeed = true,
      clusterBy = ClusterBy.PRIMARY_KEY,
      timetravelDays = 35
    )
    with ChangeKey[sr_raw.ct_gbl_ghp.E_tcurw] {
  override def sourceTableSpec: TableSpec[sr_raw.ct_gbl_ghp.E_tcurw] = sr_raw.ct_gbl_ghp.tcurw
...
sealed class C_tcurw(prefix: String) extends ColumnWithNameAccessor {
  ...
  val curvw: ColumnWithName = ColumnWithName(prefix + "curvw")
