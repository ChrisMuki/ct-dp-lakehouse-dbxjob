...
object t006a
    extends TableSpec[E_t006a](
      enableChangeDataFeed = true,
      clusterBy = ClusterBy.PRIMARY_KEY,
      timetravelDays = 35
    )
    with ChangeKey[sr_raw.ct_gbl_ghp.E_t006a] {
  override def sourceTableSpec: TableSpec[sr_raw.ct_gbl_ghp.E_t006a] = sr_raw.ct_gbl_ghp.t006a
  ...
  override def preApplyMapping: Seq[(String, Column)] = Seq(
    ...
    ("mseh3", col("mseh3_string")),
    ("mseh6", col("mseh6_string")),
    ("mseht", col("mseht_string")),
    ("msehl", col("msehl_string"))
  )
}
...
sealed class C_t006a(prefix: String) extends ColumnWithNameAccessor {
  ...
  val mseh3: ColumnWithName = ColumnWithName(prefix + "mseh3")
  val mseh6: ColumnWithName = ColumnWithName(prefix + "mseh6")
  val mseht: ColumnWithName = ColumnWithName(prefix + "mseht")
  val msehl: ColumnWithName = ColumnWithName(prefix + "msehl")
...
object C_t006a extends C_t006a("") {
  def as(alias: String): C_t006a = new C_t006a(alias + ".")
}
