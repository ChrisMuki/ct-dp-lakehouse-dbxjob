...
object tcurc
    extends TableSpec[E_tcurc](
      enableChangeDataFeed = true,
      clusterBy = ClusterBy.PRIMARY_KEY,
      timetravelDays = 35
    )
    with ChangeKey[sr_raw.ct_gbl_ghp.E_tcurc] {
  override def sourceTableSpec: TableSpec[sr_raw.ct_gbl_ghp.E_tcurc] = sr_raw.ct_gbl_ghp.tcurc
  ...
  override def preApplyMapping: Seq[(String, Column)] = Seq(
    ...
    ("isocd", col("isocd_string")),
    ("altwr", col("altwr_string")),
    ("gdatu", col("gdatu_string")),
    ("xprimary", col("xprimary_string"))
  )
}
...
sealed class C_tcurc(prefix: String) extends ColumnWithNameAccessor {
  val mandt: ColumnWithName = ColumnWithName(prefix + "mandt")
  val waers: ColumnWithName = ColumnWithName(prefix + "waers")
  val isocd: ColumnWithName = ColumnWithName(prefix + "isocd")
  val altwr: ColumnWithName = ColumnWithName(prefix + "altwr")
  val gdatu: ColumnWithName = ColumnWithName(prefix + "gdatu")
  val xprimary: ColumnWithName = ColumnWithName(prefix + "xprimary")
...
object C_tcurc extends C_tcurc("") {
  def as(alias: String): C_tcurc = new C_tcurc(alias + ".")
}
