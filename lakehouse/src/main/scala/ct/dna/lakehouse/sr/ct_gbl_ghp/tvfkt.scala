...
object tvfkt
    extends TableSpec[E_tvfkt](
      enableChangeDataFeed = true,
      clusterBy = ClusterBy.PRIMARY_KEY,
      timetravelDays = 35
    )
    with ChangeKey[sr_raw.ct_gbl_ghp.E_tvfkt] {
  override def sourceTableSpec: TableSpec[sr_raw.ct_gbl_ghp.E_tvfkt] = sr_raw.ct_gbl_ghp.tvfkt
...
sealed class C_tvfkt(prefix: String) extends ColumnWithNameAccessor {
...
object C_tvfkt extends C_tvfkt("") {
  def as(alias: String): C_tvfkt = new C_tvfkt(alias + ".")
}
