...
object t025k
    extends TableSpec[E_t025k](
      enableChangeDataFeed = true,
      clusterBy = ClusterBy.PRIMARY_KEY,
      timetravelDays = 35
    )
    with ChangeKey[sr_raw.ct_gbl_ghp.E_t025k] {
  override def sourceTableSpec: TableSpec[sr_raw.ct_gbl_ghp.E_t025k] = sr_raw.ct_gbl_ghp.t025k
...
sealed class C_t025k(prefix: String) extends ColumnWithNameAccessor {
...
object C_t025k extends C_t025k("") {
  def as(alias: String): C_t025k = new C_t025k(alias + ".")
}
