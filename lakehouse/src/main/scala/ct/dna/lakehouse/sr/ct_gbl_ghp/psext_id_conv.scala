...
object psext_id_conv
    extends TableSpec[E_psext_id_conv](
      enableChangeDataFeed = true,
      clusterBy = ClusterBy.PRIMARY_KEY,
      timetravelDays = 35
    )
    with ChangeKey[sr_raw.ct_gbl_ghp.E_psext_id_conv] {
  override def sourceTableSpec: TableSpec[sr_raw.ct_gbl_ghp.E_psext_id_conv] = sr_raw.ct_gbl_ghp.psext_id_conv
  ...
  override def preApplyMapping: Seq[(String, Column)] = Seq(
    ...
    ("ext_id_conv", col("ext_id_conv_string"))
  )
}
...
sealed class C_psext_id_conv(prefix: String) extends ColumnWithNameAccessor {
  val mandt: ColumnWithName = ColumnWithName(prefix + "mandt")
  val objnr: ColumnWithName = ColumnWithName(prefix + "objnr")
  val ext_id_conv: ColumnWithName = ColumnWithName(prefix + "ext_id_conv")
...
object C_psext_id_conv extends C_psext_id_conv("") {
  def as(alias: String): C_psext_id_conv = new C_psext_id_conv(alias + ".")
}
