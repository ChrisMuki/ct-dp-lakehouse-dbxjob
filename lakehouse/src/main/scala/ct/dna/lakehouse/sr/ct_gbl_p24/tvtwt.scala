...
object tvtwt
    extends TableSpec[E_tvtwt](
      enableChangeDataFeed = true,
      clusterBy = ClusterBy.PRIMARY_KEY,
      timetravelDays = 35
    )
    with ChangeKey[sr_raw.ct_gbl_p24.E_tvtwt] {
  override def sourceTableSpec: TableSpec[sr_raw.ct_gbl_p24.E_tvtwt] = sr_raw.ct_gbl_p24.tvtwt
