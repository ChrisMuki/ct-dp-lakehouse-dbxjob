...
object tvzbt
    extends TableSpec[E_tvzbt](
      enableChangeDataFeed = true,
      clusterBy = ClusterBy.PRIMARY_KEY,
      timetravelDays = 35
    )
    with ChangeKey[sr_raw.ct_gbl_ghp.E_tvzbt] {
  override def sourceTableSpec: TableSpec[sr_raw.ct_gbl_ghp.E_tvzbt] = sr_raw.ct_gbl_ghp.tvzbt
...
sealed class C_tvzbt(prefix: String) extends ColumnWithNameAccessor {
...
object C_tvzbt extends C_tvzbt("") {
  def as(alias: String): C_tvzbt = new C_tvzbt(alias + ".")
}
