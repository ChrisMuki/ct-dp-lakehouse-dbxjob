...
object t134t
    extends TableSpec[E_t134t](
      enableChangeDataFeed = true,
      clusterBy = ClusterBy.PRIMARY_KEY,
      timetravelDays = 35
    )
    with ChangeKey[sr_raw.ct_gbl_ghp.E_t134t] {
  override def sourceTableSpec: TableSpec[sr_raw.ct_gbl_ghp.E_t134t] = sr_raw.ct_gbl_ghp.t134t
...
object C_t134t extends C_t134t("") {
  def as(alias: String): C_t134t = new C_t134t(alias + ".")
}
