...
object makt
    extends TableSpec[E_makt](
      enableChangeDataFeed = true,
      clusterBy = ClusterBy.PRIMARY_KEY,
      timetravelDays = 35
    )
    with ChangeKey[sr_raw.ct_gbl_p69.E_makt] {
  override def sourceTableSpec: TableSpec[sr_raw.ct_gbl_p69.E_makt] = sr_raw.ct_gbl_p69.makt
...
sealed class C_makt(prefix: String) extends ColumnWithNameAccessor {
  ...
  val maktg: ColumnWithName = ColumnWithName(prefix + "maktg")
