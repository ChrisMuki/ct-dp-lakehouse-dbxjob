...
object tmvft
    extends TableSpec[E_tmvft](
      enableChangeDataFeed = true,
      clusterBy = ClusterBy.PRIMARY_KEY,
      timetravelDays = 35
    )
    with ChangeKey[sr_raw.ct_gbl_ghp.E_tmvft] {
  override def sourceTableSpec: TableSpec[sr_raw.ct_gbl_ghp.E_tmvft] = sr_raw.ct_gbl_ghp.tmvft
