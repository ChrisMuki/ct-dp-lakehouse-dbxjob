...
import ct.dna.lakehouse.sr_raw.ct_gbl_p61.{konh => sr_raw_konh}
...
object konh extends TableSpec[SrKonh] with ChangeKey[ct.dna.lakehouse.sr_raw.ct_gbl_p61.E_konh] {

  override def sourceTableSpec: TableSpec[ct.dna.lakehouse.sr_raw.ct_gbl_p61.E_konh] = sr_raw_konh
