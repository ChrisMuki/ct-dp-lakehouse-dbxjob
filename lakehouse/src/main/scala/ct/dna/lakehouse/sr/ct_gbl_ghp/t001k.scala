...
object t001k
    ...
    with ChangeKey[sr_raw.ct_gbl_ghp.E_t001k] {
  override def sourceTableSpec: TableSpec[sr_raw.ct_gbl_ghp.E_t001k] = sr_raw.ct_gbl_ghp.t001k
...
sealed class C_t001k(prefix: String) extends ColumnWithNameAccessor {
  ...
  val _fmp_prsfr: ColumnWithName = ColumnWithName(prefix + "_fmp_prsfr")
  val _fmp_prfrgr: ColumnWithName = ColumnWithName(prefix + "_fmp_prfrgr")
