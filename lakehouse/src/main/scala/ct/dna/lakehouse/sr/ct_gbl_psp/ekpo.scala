...
object ekpo
    ...
    with ChangeKey[Joined[sr_raw.ct_gbl_psp.E_ekpo_part1, sr_raw.ct_gbl_psp.E_ekpo_part2]] {
  override def sourceTableSpec: TableSpec[Joined[sr_raw.ct_gbl_psp.E_ekpo_part1, sr_raw.ct_gbl_psp.E_ekpo_part2]] = sr_raw.ct_gbl_psp.ekpo
  ...
  override def preApplyMapping: Seq[(String, Column)] = Seq(
    ...
    ("delivery_address_type", col("delivery_address_type_string")),
    ...
    ("loadingpoint", col("loadingpoint_string")),
    ...
    ("vcm_chain_category", col("vcm_chain_category_string")),
...
sealed class C_ekpo(prefix: String) extends ColumnWithNameAccessor {
  ...
  val uniqueid: ColumnWithName = ColumnWithName(prefix + "uniqueid")
  ...
  val delivery_address_type: ColumnWithName = ColumnWithName(prefix + "delivery_address_type")
  ...
  val loadingpoint: ColumnWithName = ColumnWithName(prefix + "loadingpoint")
  ...
  val vcm_chain_category: ColumnWithName = ColumnWithName(prefix + "vcm_chain_category")
