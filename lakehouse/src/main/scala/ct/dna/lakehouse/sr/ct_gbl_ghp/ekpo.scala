...
object ekpo
    ...
    with ChangeKey[Joined[sr_raw.ct_gbl_ghp.E_ekpo_part1, sr_raw.ct_gbl_ghp.E_ekpo_part2]] {
  override def sourceTableSpec: TableSpec[Joined[sr_raw.ct_gbl_ghp.E_ekpo_part1, sr_raw.ct_gbl_ghp.E_ekpo_part2]] = sr_raw.ct_gbl_ghp.ekpo
