...
import ct.dna.lakehouse.sr_raw.ct_gbl_p12.{stko => sr_raw_stko}
...
case class SrStko(
    ...
    zztemp: String,
    zzzeit: String,
    @Decimal(13, 3) zzgewicht: java.math.BigDecimal,
    zzmeins: String,
    zserst: String
) extends Entity

object stko extends TableSpec[SrStko] with ChangeKey[ct.dna.lakehouse.sr_raw.ct_gbl_p12.E_stko] {

  override def sourceTableSpec: TableSpec[ct.dna.lakehouse.sr_raw.ct_gbl_p12.E_stko] = sr_raw_stko
