...
import ct.dna.lakehouse.sr_raw.ct_gbl_p61.{marm => sr_raw_marm}
...
object marm extends TableSpec[SrMarm] with ChangeKey[ct.dna.lakehouse.sr_raw.ct_gbl_p61.E_marm] {

  override def sourceTableSpec: TableSpec[ct.dna.lakehouse.sr_raw.ct_gbl_p61.E_marm] = sr_raw_marm
