...
object tvakt
    ...
    with ChangeKey[sr_raw.ct_gbl_epp.E_tvakt] {
  override def sourceTableSpec: TableSpec[sr_raw.ct_gbl_epp.E_tvakt] = sr_raw.ct_gbl_epp.tvakt
  ...
  override def preApplyMapping: Seq[(String, Column)] = Seq(
    ...
    ("txt_button", col("txt_button_string"))
  )
}
...
sealed class C_tvakt(prefix: String) extends ColumnWithNameAccessor {
  ...
  val txt_button: ColumnWithName = ColumnWithName(prefix + "txt_button")
