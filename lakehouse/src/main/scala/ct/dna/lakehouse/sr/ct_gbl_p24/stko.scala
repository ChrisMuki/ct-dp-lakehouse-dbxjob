...
import ct.dna.lakehouse.sr_raw.ct_gbl_p24.{stko => sr_raw_stko}
...
object stko extends TableSpec[SrStko] with ChangeKey[ct.dna.lakehouse.sr_raw.ct_gbl_p24.E_stko] {

  override def sourceTableSpec: TableSpec[ct.dna.lakehouse.sr_raw.ct_gbl_p24.E_stko] = sr_raw_stko
