...
object t077y
    extends TableSpec[E_t077y](
      enableChangeDataFeed = true,
      clusterBy = ClusterBy.PRIMARY_KEY,
      timetravelDays = 35
    )
    with ChangeKey[sr_raw.ct_gbl_ghp.E_t077y] {
  override def sourceTableSpec: TableSpec[sr_raw.ct_gbl_ghp.E_t077y] = sr_raw.ct_gbl_ghp.t077y
...
sealed class C_t077y(prefix: String) extends ColumnWithNameAccessor {
...
object C_t077y extends C_t077y("") {
  def as(alias: String): C_t077y = new C_t077y(alias + ".")
}
