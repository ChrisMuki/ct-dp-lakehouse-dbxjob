...
object t151t
    extends TableSpec[E_t151t](
      enableChangeDataFeed = true,
      clusterBy = ClusterBy.PRIMARY_KEY,
      timetravelDays = 35
    )
    with ChangeKey[sr_raw.ct_gbl_ghp.E_t151t] {
  override def sourceTableSpec: TableSpec[sr_raw.ct_gbl_ghp.E_t151t] = sr_raw.ct_gbl_ghp.t151t
...
sealed class C_t151t(prefix: String) extends ColumnWithNameAccessor {
...
object C_t151t extends C_t151t("") {
  def as(alias: String): C_t151t = new C_t151t(alias + ".")
}
