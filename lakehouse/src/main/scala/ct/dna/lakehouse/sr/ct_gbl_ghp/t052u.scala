...
object t052u
    extends TableSpec[E_t052u](
      enableChangeDataFeed = true,
      clusterBy = ClusterBy.PRIMARY_KEY,
      timetravelDays = 35
    )
    with ChangeKey[sr_raw.ct_gbl_ghp.E_t052u] {
  override def sourceTableSpec: TableSpec[sr_raw.ct_gbl_ghp.E_t052u] = sr_raw.ct_gbl_ghp.t052u
...
sealed class C_t052u(prefix: String) extends ColumnWithNameAccessor {
...
object C_t052u extends C_t052u("") {
  def as(alias: String): C_t052u = new C_t052u(alias + ".")
}
