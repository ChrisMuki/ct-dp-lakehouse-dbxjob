...
import ct.dna.lakehouse.sr_raw.ct_gbl_epp.{t024d => sr_raw_t024d}
...
object t024d extends TableSpec[SrT024d] with ChangeKey[ct.dna.lakehouse.sr_raw.ct_gbl_epp.E_t024d] {

  override def sourceTableSpec: TableSpec[ct.dna.lakehouse.sr_raw.ct_gbl_epp.E_t024d] = sr_raw_t024d
