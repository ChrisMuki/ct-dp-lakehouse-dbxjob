...
import ct.dna.lakehouse.sr_raw.ct_gbl_p61.{t024 => sr_raw_t024}
...
object t024 extends TableSpec[SrT024] with ChangeKey[ct.dna.lakehouse.sr_raw.ct_gbl_p61.E_t024] {

  override def sourceTableSpec: TableSpec[ct.dna.lakehouse.sr_raw.ct_gbl_p61.E_t024] = sr_raw_t024
