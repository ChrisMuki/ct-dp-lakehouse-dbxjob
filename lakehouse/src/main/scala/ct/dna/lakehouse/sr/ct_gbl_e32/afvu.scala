...
import ct.dna.lakehouse.sr_raw.ct_gbl_e32.{afvu => sr_raw_afvu}
...
object afvu extends TableSpec[SrAfvu] with ChangeKey[ct.dna.lakehouse.sr_raw.ct_gbl_e32.E_afvu] {

  override def sourceTableSpec: TableSpec[ct.dna.lakehouse.sr_raw.ct_gbl_e32.E_afvu] = sr_raw_afvu
