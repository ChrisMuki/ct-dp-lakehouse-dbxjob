...
object vtsp
    ...
    with ChangeKey[sr_raw.ct_gbl_ghp.E_vtsp] {
  override def sourceTableSpec: TableSpec[sr_raw.ct_gbl_ghp.E_vtsp] = sr_raw.ct_gbl_ghp.vtsp
  ...
  override def preApplyMapping: Seq[(String, Column)] = Seq(
    ...
    ("tknum", col("tknum_string")),
    ("tsnum", col("tsnum_string")),
    ("tpnum", col("tpnum_string"))
  )
}
...
sealed class C_vtsp(prefix: String) extends ColumnWithNameAccessor {
  ...
  val tknum: ColumnWithName = ColumnWithName(prefix + "tknum")
  val tsnum: ColumnWithName = ColumnWithName(prefix + "tsnum")
  val tpnum: ColumnWithName = ColumnWithName(prefix + "tpnum")
