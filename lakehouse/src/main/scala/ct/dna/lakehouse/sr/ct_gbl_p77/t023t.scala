...
object t023t
    extends TableSpec[E_t023t](
      enableChangeDataFeed = true,
      clusterBy = ClusterBy.PRIMARY_KEY,
      timetravelDays = 35
    )
    with ChangeKey[sr_raw.ct_gbl_p77.E_t023t] {
  override def sourceTableSpec: TableSpec[sr_raw.ct_gbl_p77.E_t023t] = sr_raw.ct_gbl_p77.t023t
...
sealed class C_t023t(prefix: String) extends ColumnWithNameAccessor {
  ...
  val wgbez60: ColumnWithName = ColumnWithName(prefix + "wgbez60")
...
object C_t023t extends C_t023t("") {
  def as(alias: String): C_t023t = new C_t023t(alias + ".")
}
