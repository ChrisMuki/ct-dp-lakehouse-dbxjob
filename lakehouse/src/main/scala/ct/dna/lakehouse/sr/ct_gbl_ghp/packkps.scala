...
object packkps
    ...
    with ChangeKey[sr_raw.ct_gbl_ghp.E_packkps] {
  override def sourceTableSpec: TableSpec[sr_raw.ct_gbl_ghp.E_packkps] = sr_raw.ct_gbl_ghp.packkps
  ...
  override def preApplyMapping: Seq[(String, Column)] = Seq(
    ...
    ("content", col("content_string")),
    ("content_up", col("content_up_string"))
  )
}
...
sealed class C_packkps(prefix: String) extends ColumnWithNameAccessor {
  ...
  val content: ColumnWithName = ColumnWithName(prefix + "content")
  val content_up: ColumnWithName = ColumnWithName(prefix + "content_up")
