...
import ct.dna.lakehouse.sr_raw.ct_gbl_psp.{t001k => sr_raw_t001k}
...
object t001k extends TableSpec[SrT001k] with ChangeKey[ct.dna.lakehouse.sr_raw.ct_gbl_psp.E_t001k] {

  override def sourceTableSpec: TableSpec[ct.dna.lakehouse.sr_raw.ct_gbl_psp.E_t001k] = sr_raw_t001k
