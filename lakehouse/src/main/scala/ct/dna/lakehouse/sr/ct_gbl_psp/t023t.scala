...
import ct.dna.lakehouse.sr_raw.ct_gbl_psp.{t023t => sr_raw_t023t}
...
object t023t extends TableSpec[SrT023t] with ChangeKey[ct.dna.lakehouse.sr_raw.ct_gbl_psp.E_t023t] {

  override def sourceTableSpec: TableSpec[ct.dna.lakehouse.sr_raw.ct_gbl_psp.E_t023t] = sr_raw_t023t
