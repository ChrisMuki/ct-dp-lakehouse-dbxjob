...
object t300t
    extends TableSpec[E_t300t](
      enableChangeDataFeed = true,
      clusterBy = ClusterBy.PRIMARY_KEY,
      timetravelDays = 35
    )
    with ChangeKey[sr_raw.ct_gbl_ghp.E_t300t] {
  override def sourceTableSpec: TableSpec[sr_raw.ct_gbl_ghp.E_t300t] = sr_raw.ct_gbl_ghp.t300t
...
sealed class C_t300t(prefix: String) extends ColumnWithNameAccessor {
  ...
  val lnumt: ColumnWithName = ColumnWithName(prefix + "lnumt")
...
object C_t300t extends C_t300t("") {
  def as(alias: String): C_t300t = new C_t300t(alias + ".")
}
