...
import ct.dna.lakehouse.sr_raw.ct_gbl_p24.{makt => sr_raw_makt}
...
object makt extends TableSpec[SrMakt] with ChangeKey[ct.dna.lakehouse.sr_raw.ct_gbl_p24.E_makt] {

  override def sourceTableSpec: TableSpec[ct.dna.lakehouse.sr_raw.ct_gbl_p24.E_makt] = sr_raw_makt
