...
import ct.dna.lakehouse.sr_raw.ct_gbl_epp.{knmt => sr_raw_knmt}
...
object knmt extends TableSpec[SrKnmt] with ChangeKey[ct.dna.lakehouse.sr_raw.ct_gbl_epp.E_knmt] {

  override def sourceTableSpec: TableSpec[ct.dna.lakehouse.sr_raw.ct_gbl_epp.E_knmt] = sr_raw_knmt
