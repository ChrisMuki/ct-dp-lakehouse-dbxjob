...
object a018
    extends TableSpec[E_a018](
      enableChangeDataFeed = true,
      clusterBy = ClusterBy.PRIMARY_KEY,
      timetravelDays = 35
    )
    with ChangeKey[sr_raw.ct_gbl_p69.E_a018] {
  override def sourceTableSpec: TableSpec[sr_raw.ct_gbl_p69.E_a018] = sr_raw.ct_gbl_p69.a018
...
sealed class C_a018(prefix: String) extends ColumnWithNameAccessor {
...
object C_a018 extends C_a018("") {
  def as(alias: String): C_a018 = new C_a018(alias + ".")
}
