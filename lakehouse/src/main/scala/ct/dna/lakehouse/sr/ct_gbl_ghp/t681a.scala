...
object t681a
    extends TableSpec[E_t681a](
      enableChangeDataFeed = true,
      clusterBy = ClusterBy.PRIMARY_KEY,
      timetravelDays = 35
    )
    with ChangeKey[sr_raw.ct_gbl_ghp.E_t681a] {
  override def sourceTableSpec: TableSpec[sr_raw.ct_gbl_ghp.E_t681a] = sr_raw.ct_gbl_ghp.t681a
...
sealed class C_t681a(prefix: String) extends ColumnWithNameAccessor {
...
object C_t681a extends C_t681a("") {
  def as(alias: String): C_t681a = new C_t681a(alias + ".")
}
