...
object tbslt
    extends TableSpec[E_tbslt](
      enableChangeDataFeed = true,
      clusterBy = ClusterBy.PRIMARY_KEY,
      timetravelDays = 35
    )
    with ChangeKey[sr_raw.ct_gbl_ghp.E_tbslt] {
  override def sourceTableSpec: TableSpec[sr_raw.ct_gbl_ghp.E_tbslt] = sr_raw.ct_gbl_ghp.tbslt
...
sealed class C_tbslt(prefix: String) extends ColumnWithNameAccessor {
...
object C_tbslt extends C_tbslt("") {
  def as(alias: String): C_tbslt = new C_tbslt(alias + ".")
}
