...
object user_member_of
    extends TableSpec[E_user_member_of](
...
sealed class C_user_member_of(prefix: String) extends ColumnWithNameAccessor {
...
object C_user_member_of extends C_user_member_of("") {
  def as(alias: String): C_user_member_of = new C_user_member_of(alias + ".")
}
