...
case class E_locdb_legal_entities(
    @PK _mk_org: String,
    @PK _mk_site: String,
    ...
    legal_entity_id_string: String
) extends Entity

object locdb_legal_entities
    extends TableSpec[E_locdb_legal_entities](
...
sealed class C_locdb_legal_entities(prefix: String) extends ColumnWithNameAccessor {
  ...
  val legal_entity_name_string: ColumnWithName = ColumnWithName(prefix + "legal_entity_name_string")
  val legal_entity_id_string: ColumnWithName = ColumnWithName(prefix + "legal_entity_id_string")
}

object C_locdb_legal_entities extends C_locdb_legal_entities("") {
  def as(alias: String): C_locdb_legal_entities = new C_locdb_legal_entities(alias + ".")
}
