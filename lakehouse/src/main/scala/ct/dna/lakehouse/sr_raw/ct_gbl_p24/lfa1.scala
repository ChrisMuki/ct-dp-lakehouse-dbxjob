...
case class E_lfa1(
    ...
    zname1_string: String,
    zname2_string: String,
    zname3_string: String,
    zsvgr_string: String
) extends Entity
...
sealed class C_lfa1(prefix: String) extends ColumnWithNameAccessor {
  ...
  val zname1_string: ColumnWithName = ColumnWithName(prefix + "zname1_string")
  val zname2_string: ColumnWithName = ColumnWithName(prefix + "zname2_string")
  val zname3_string: ColumnWithName = ColumnWithName(prefix + "zname3_string")
