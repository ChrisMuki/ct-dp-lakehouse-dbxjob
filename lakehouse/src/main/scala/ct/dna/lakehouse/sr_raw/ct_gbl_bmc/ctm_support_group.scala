...
case class E_ctm_support_group(
    @PK _mk_org: String,
    @PK _mk_site: String,
    ...
    support_group_id_string: String,
    support_group_name_string: String
) extends Entity

object ctm_support_group
    extends TableSpec[E_ctm_support_group](
...
sealed class C_ctm_support_group(prefix: String) extends ColumnWithNameAccessor {
  ...
  val support_group_id_string: ColumnWithName = ColumnWithName(prefix + "support_group_id_string")
  val support_group_name_string: ColumnWithName = ColumnWithName(prefix + "support_group_name_string")
}

object C_ctm_support_group extends C_ctm_support_group("") {
  def as(alias: String): C_ctm_support_group = new C_ctm_support_group(alias + ".")
}
