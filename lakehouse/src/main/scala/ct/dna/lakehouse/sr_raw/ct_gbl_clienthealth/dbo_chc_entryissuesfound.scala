...
case class E_dbo_chc_entryissuesfound(
    @PK _mk_org: String,
    @PK _mk_site: String,
...
object dbo_chc_entryissuesfound
    extends TableSpec[E_dbo_chc_entryissuesfound](
...
sealed class C_dbo_chc_entryissuesfound(prefix: String) extends ColumnWithNameAccessor {
...
object C_dbo_chc_entryissuesfound extends C_dbo_chc_entryissuesfound("") {
  def as(alias: String): C_dbo_chc_entryissuesfound = new C_dbo_chc_entryissuesfound(alias + ".")
}
