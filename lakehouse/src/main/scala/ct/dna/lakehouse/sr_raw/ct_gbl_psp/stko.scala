...
sealed class C_stko(prefix: String) extends ColumnWithNameAccessor {
  ...
  val versnst_string: ColumnWithName = ColumnWithName(prefix + "versnst_string")
  val versnlastind_string: ColumnWithName = ColumnWithName(prefix + "versnlastind_string")
  val lastchangedatetime_decimal_21_7: ColumnWithName = ColumnWithName(prefix + "lastchangedatetime_decimal_21_7")
  val bom_ain_ind_string: ColumnWithName = ColumnWithName(prefix + "bom_ain_ind_string")
  val bom_prev_versn_string: ColumnWithName = ColumnWithName(prefix + "bom_prev_versn_string")
  val dummy_stko_incl_eew_ps_string: ColumnWithName = ColumnWithName(prefix + "dummy_stko_incl_eew_ps_string")
}
