...
case class E_afko(
    ...
    zzaufnr_string: String,
    zznetnr_string: String,
    zztext1_string: String,
    zztext2_string: String,
    zztext3_string: String
) extends Entity
...
sealed class C_afko(prefix: String) extends ColumnWithNameAccessor {
  ...
  val zzaufnr_string: ColumnWithName = ColumnWithName(prefix + "zzaufnr_string")
  val zznetnr_string: ColumnWithName = ColumnWithName(prefix + "zznetnr_string")
  val zztext1_string: ColumnWithName = ColumnWithName(prefix + "zztext1_string")
  val zztext2_string: ColumnWithName = ColumnWithName(prefix + "zztext2_string")
  val zztext3_string: ColumnWithName = ColumnWithName(prefix + "zztext3_string")
}
