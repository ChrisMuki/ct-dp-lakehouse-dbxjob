...
case class E_vbap_part2(
    ...
    @Decimal(15, 3) zzmenge_decimal_15_3: BigDecimal,
    zzstamp_string: String,
    zzfpd_string: String,
    zztgt_string: String
) extends Entity
...
sealed class C_vbap(prefix: String) extends ColumnWithNameAccessor {
  ...
  val zzmenge_decimal_15_3: ColumnWithName = ColumnWithName(prefix + "zzmenge_decimal_15_3")
  val zzstamp_string: ColumnWithName = ColumnWithName(prefix + "zzstamp_string")
