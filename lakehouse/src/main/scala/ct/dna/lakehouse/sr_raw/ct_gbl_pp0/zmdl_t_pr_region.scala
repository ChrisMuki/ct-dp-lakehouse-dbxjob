...
case class E_zmdl_t_pr_region(
    ...
    pr_region_name_string: String,
    geog_region_string: String,
    comments_string: String,
    last_changed_by_string: String,
    last_changed_on_string: String
) extends Entity

object zmdl_t_pr_region
    extends TableSpec[E_zmdl_t_pr_region](
...
sealed class C_zmdl_t_pr_region(prefix: String) extends ColumnWithNameAccessor {
  ...
  val pr_region_name_string: ColumnWithName = ColumnWithName(prefix + "pr_region_name_string")
  val geog_region_string: ColumnWithName = ColumnWithName(prefix + "geog_region_string")
...
object C_zmdl_t_pr_region extends C_zmdl_t_pr_region("") {
  def as(alias: String): C_zmdl_t_pr_region = new C_zmdl_t_pr_region(alias + ".")
}
