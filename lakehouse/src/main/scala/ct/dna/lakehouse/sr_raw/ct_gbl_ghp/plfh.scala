...
case class E_plfh(
    ...
    versn_source_pzlfh_string: String,
    versn_origin_routing_string: String,
    claimable_string: String,
    registrable_string: String
) extends Entity
...
sealed class C_plfh(prefix: String) extends ColumnWithNameAccessor {
  ...
  val versn_source_pzlfh_string: ColumnWithName = ColumnWithName(prefix + "versn_source_pzlfh_string")
  val versn_origin_routing_string: ColumnWithName = ColumnWithName(prefix + "versn_origin_routing_string")
  val claimable_string: ColumnWithName = ColumnWithName(prefix + "claimable_string")
  val registrable_string: ColumnWithName = ColumnWithName(prefix + "registrable_string")
}
