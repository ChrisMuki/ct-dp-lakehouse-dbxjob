...
case class E_afvu(
    ...
    zkzinv_string: String,
    zzanln1_string: String,
    zattestat_string: String,
...
sealed class C_afvu(prefix: String) extends ColumnWithNameAccessor {
  ...
  val zkzinv_string: ColumnWithName = ColumnWithName(prefix + "zkzinv_string")
  val zzanln1_string: ColumnWithName = ColumnWithName(prefix + "zzanln1_string")
  val zattestat_string: ColumnWithName = ColumnWithName(prefix + "zattestat_string")
