...
case class E_locdb_location_codes(
    @PK _mk_org: String,
    @PK _mk_site: String,
...
object locdb_location_codes
    extends TableSpec[E_locdb_location_codes](
...
sealed class C_locdb_location_codes(prefix: String) extends ColumnWithNameAccessor {
...
object C_locdb_location_codes extends C_locdb_location_codes("") {
  def as(alias: String): C_locdb_location_codes = new C_locdb_location_codes(alias + ".")
}
