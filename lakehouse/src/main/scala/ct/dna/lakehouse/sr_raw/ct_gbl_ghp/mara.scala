...
case class E_mara_part1(
    ...
    zz1_r3_mandt_prd_string: String,
    zz1_r3_sysid_prd_string: String,
    zz1_r3_matnr_prd_string: String,
    ...
    newprod_indi_string: String,
    prd_startdt_string: String,
    prd_enddt_string: String,
    inv_pln_mode_string: String,
    flagclass_string: String,
...
case class E_mara_part2(
    ...
    som_ctr_autorenewal_string: String,
    mcond_string: String,
    ...
    dfs_sensitivity_key_string: String,
    dfs_mfrp2_string: String,
    ovlpn_string: String,
    adspc_spc_string: String,
    varid_binary: Array[Byte],
    msbookpartno_string: String,
    tolerance_type_string: String,
    dpcbt_string: String,
    xgrdt_string: String,
    imatn_string: String,
...
sealed class C_mara(prefix: String) extends ColumnWithNameAccessor {
  ...
  val productoid_string: ColumnWithName = ColumnWithName(prefix + "productoid_string")
  ...
  val zz1_r3_mandt_prd_string: ColumnWithName = ColumnWithName(prefix + "zz1_r3_mandt_prd_string")
  val zz1_r3_sysid_prd_string: ColumnWithName = ColumnWithName(prefix + "zz1_r3_sysid_prd_string")
  val zz1_r3_matnr_prd_string: ColumnWithName = ColumnWithName(prefix + "zz1_r3_matnr_prd_string")
  ...
  val newprod_indi_string: ColumnWithName = ColumnWithName(prefix + "newprod_indi_string")
  val prd_startdt_string: ColumnWithName = ColumnWithName(prefix + "prd_startdt_string")
  val prd_enddt_string: ColumnWithName = ColumnWithName(prefix + "prd_enddt_string")
  val inv_pln_mode_string: ColumnWithName = ColumnWithName(prefix + "inv_pln_mode_string")
  val flagclass_string: ColumnWithName = ColumnWithName(prefix + "flagclass_string")
  ...
  val som_ctr_autorenewal_string: ColumnWithName = ColumnWithName(prefix + "som_ctr_autorenewal_string")
  ...
  val dfs_sensitivity_key_string: ColumnWithName = ColumnWithName(prefix + "dfs_sensitivity_key_string")
  val dfs_mfrp2_string: ColumnWithName = ColumnWithName(prefix + "dfs_mfrp2_string")
  ...
  val tolerance_type_string: ColumnWithName = ColumnWithName(prefix + "tolerance_type_string")
