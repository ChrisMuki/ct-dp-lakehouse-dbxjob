...
case class E_reguh(
    ...
    anfae_string: String,
    wefae_string: String,
    @Decimal(23, 2) rbetr_decimal_23_2: BigDecimal,
    @Decimal(23, 2) rskon_decimal_23_2: BigDecimal,
    @Decimal(23, 2) rwbtr_decimal_23_2: BigDecimal,
    @Decimal(23, 2) rwskt_decimal_23_2: BigDecimal,
    @Decimal(23, 2) rspe1_decimal_23_2: BigDecimal,
    @Decimal(23, 2) rspe2_decimal_23_2: BigDecimal,
    @Decimal(5, 0) rpost_decimal_5_0: BigDecimal,
    @Decimal(5, 0) rtext_decimal_5_0: BigDecimal,
    @Decimal(23, 2) rspm1_decimal_23_2: BigDecimal,
    @Decimal(23, 2) rspm2_decimal_23_2: BigDecimal,
    @Decimal(23, 2) wehmx_decimal_23_2: BigDecimal,
    @Decimal(23, 2) wefmx_decimal_23_2: BigDecimal,
    @Decimal(23, 2) wehrs_decimal_23_2: BigDecimal,
    @Decimal(23, 2) wefrs_decimal_23_2: BigDecimal,
    ...
    abwae_string: String,
    @Decimal(23, 2) skvhw_decimal_23_2: BigDecimal,
    @Decimal(23, 2) skvfw_decimal_23_2: BigDecimal,
    @Decimal(23, 2) dskvh_decimal_23_2: BigDecimal,
    zpst2_string: String,
    paygr_string: String,
    zbnky_string: String,
    ubnky_string: String,
    pstl2_string: String,
    absbu_string: String,
    @Decimal(23, 2) rbet2_decimal_23_2: BigDecimal,
    @Decimal(23, 2) rbet3_decimal_23_2: BigDecimal,
    @Decimal(23, 2) rsko2_decimal_23_2: BigDecimal,
    @Decimal(23, 2) rsko3_decimal_23_2: BigDecimal,
    ...
    uetr_string: String,
    zpayment_system_string: String,
    zalias_type_string: String,
    zbank_alias_string: String,
...
sealed class C_reguh(prefix: String) extends ColumnWithNameAccessor {
  ...
  val zbnkn_long_string: ColumnWithName = ColumnWithName(prefix + "zbnkn_long_string")
  ...
  val ubknt_long_string: ColumnWithName = ColumnWithName(prefix + "ubknt_long_string")
  ...
  val rbetr_decimal_23_2: ColumnWithName = ColumnWithName(prefix + "rbetr_decimal_23_2")
  val rskon_decimal_23_2: ColumnWithName = ColumnWithName(prefix + "rskon_decimal_23_2")
  val rwbtr_decimal_23_2: ColumnWithName = ColumnWithName(prefix + "rwbtr_decimal_23_2")
  val rwskt_decimal_23_2: ColumnWithName = ColumnWithName(prefix + "rwskt_decimal_23_2")
  val rspe1_decimal_23_2: ColumnWithName = ColumnWithName(prefix + "rspe1_decimal_23_2")
  val rspe2_decimal_23_2: ColumnWithName = ColumnWithName(prefix + "rspe2_decimal_23_2")
  ...
  val rspm1_decimal_23_2: ColumnWithName = ColumnWithName(prefix + "rspm1_decimal_23_2")
  val rspm2_decimal_23_2: ColumnWithName = ColumnWithName(prefix + "rspm2_decimal_23_2")
  val wehmx_decimal_23_2: ColumnWithName = ColumnWithName(prefix + "wehmx_decimal_23_2")
  val wefmx_decimal_23_2: ColumnWithName = ColumnWithName(prefix + "wefmx_decimal_23_2")
  val wehrs_decimal_23_2: ColumnWithName = ColumnWithName(prefix + "wehrs_decimal_23_2")
  val wefrs_decimal_23_2: ColumnWithName = ColumnWithName(prefix + "wefrs_decimal_23_2")
  ...
  val skvhw_decimal_23_2: ColumnWithName = ColumnWithName(prefix + "skvhw_decimal_23_2")
  val skvfw_decimal_23_2: ColumnWithName = ColumnWithName(prefix + "skvfw_decimal_23_2")
  val dskvh_decimal_23_2: ColumnWithName = ColumnWithName(prefix + "dskvh_decimal_23_2")
  ...
  val rbet2_decimal_23_2: ColumnWithName = ColumnWithName(prefix + "rbet2_decimal_23_2")
  val rbet3_decimal_23_2: ColumnWithName = ColumnWithName(prefix + "rbet3_decimal_23_2")
  val rsko2_decimal_23_2: ColumnWithName = ColumnWithName(prefix + "rsko2_decimal_23_2")
  val rsko3_decimal_23_2: ColumnWithName = ColumnWithName(prefix + "rsko3_decimal_23_2")
  ...
  val zpayment_system_string: ColumnWithName = ColumnWithName(prefix + "zpayment_system_string")
  val zalias_type_string: ColumnWithName = ColumnWithName(prefix + "zalias_type_string")
  val zbank_alias_string: ColumnWithName = ColumnWithName(prefix + "zbank_alias_string")
