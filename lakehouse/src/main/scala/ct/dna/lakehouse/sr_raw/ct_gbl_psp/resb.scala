...
case class E_resb(
    ...
    dummy_rdi_ps_string: String,
    uvorn_string: String,
    producttype_string: String,
    serviceperformer_string: String,
    startdate_string: String,
    enddate_string: String,
    performanceperiodstarttime_string: String,
    performanceperiodendtime_string: String,
    @Decimal(5, 1) serviceduration_decimal_5_1: BigDecimal,
    servicedurationunit_string: String,
    operationworkcenteralignment_string: String,
    recipient_location_code_string: String,
    service_doc_type_string: String,
    service_doc_id_string: String,
    service_doc_item_id_string: String,
    maintordcompcmtdqtyiskept_string: String,
    original_rsnum_string: String,
    original_rspos_string: String,
    advcode_string: String,
    struc_code_string: String,
    struc_class_string: String,
    struc_classtyp_string: String,
    crm_header_id_string: String,
    crm_item_id_string: String,
    crms4_item_id_string: String,
    header_bus_type_string: String,
...
sealed class C_resb(prefix: String) extends ColumnWithNameAccessor {
  ...
  val dummy_rdi_ps_string: ColumnWithName = ColumnWithName(prefix + "dummy_rdi_ps_string")
  val uvorn_string: ColumnWithName = ColumnWithName(prefix + "uvorn_string")
  ...
  val performanceperiodstarttime_string: ColumnWithName = ColumnWithName(prefix + "performanceperiodstarttime_string")
  val performanceperiodendtime_string: ColumnWithName = ColumnWithName(prefix + "performanceperiodendtime_string")
  ...
  val operationworkcenteralignment_string: ColumnWithName = ColumnWithName(prefix + "operationworkcenteralignment_string")
  val recipient_location_code_string: ColumnWithName = ColumnWithName(prefix + "recipient_location_code_string")
  ...
  val maintordcompcmtdqtyiskept_string: ColumnWithName = ColumnWithName(prefix + "maintordcompcmtdqtyiskept_string")
  val original_rsnum_string: ColumnWithName = ColumnWithName(prefix + "original_rsnum_string")
  val original_rspos_string: ColumnWithName = ColumnWithName(prefix + "original_rspos_string")
  ...
  val crm_header_id_string: ColumnWithName = ColumnWithName(prefix + "crm_header_id_string")
  val crm_item_id_string: ColumnWithName = ColumnWithName(prefix + "crm_item_id_string")
  val crms4_item_id_string: ColumnWithName = ColumnWithName(prefix + "crms4_item_id_string")
  val header_bus_type_string: ColumnWithName = ColumnWithName(prefix + "header_bus_type_string")
