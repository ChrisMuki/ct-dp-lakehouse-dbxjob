...
@LakehouseEntity
case class pl_mysuccess_api_payscalegroup_E(
  @PK _mk_org: String,
  @PK _mk_site: String,
  ...
  payscalegroup_string: String
) extends Entity

object pl_mysuccess_api_payscalegroup extends TableSpec[pl_mysuccess_api_payscalegroup_E](
