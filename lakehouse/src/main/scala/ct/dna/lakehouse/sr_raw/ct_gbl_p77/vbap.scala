...
case class E_vbap_part2(
    ...
    zzebeln_string: String,
    zzbasic_text_string: String,
...
sealed class C_vbap(prefix: String) extends ColumnWithNameAccessor {
  ...
  val zzebeln_string: ColumnWithName = ColumnWithName(prefix + "zzebeln_string")
  val zzbasic_text_string: ColumnWithName = ColumnWithName(prefix + "zzbasic_text_string")
