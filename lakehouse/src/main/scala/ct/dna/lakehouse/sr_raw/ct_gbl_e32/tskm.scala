...
sealed class C_tskm(prefix: String) extends ColumnWithNameAccessor {
  ...
  val tatyp_string: ColumnWithName = ColumnWithName(prefix + "tatyp_string")
  val taxkm_string: ColumnWithName = ColumnWithName(prefix + "taxkm_string")
}

object C_tskm extends C_tskm("") {
  def as(alias: String): C_tskm = new C_tskm(alias + ".")
}
