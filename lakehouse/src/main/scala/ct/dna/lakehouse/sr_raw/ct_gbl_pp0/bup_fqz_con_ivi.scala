...
object bup_fqz_con_ivi
    extends TableSpec[E_bup_fqz_con_ivi](
...
sealed class C_bup_fqz_con_ivi(prefix: String) extends ColumnWithNameAccessor {
...
object C_bup_fqz_con_ivi extends C_bup_fqz_con_ivi("") {
  def as(alias: String): C_bup_fqz_con_ivi = new C_bup_fqz_con_ivi(alias + ".")
}
