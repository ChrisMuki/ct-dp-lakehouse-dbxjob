...
case class E_vbap_part2(
    ...
    zzpoko_string: String,
    zqgstand_string: String,
    zzimds_string: String,
    zzsign_string: String,
    zzmatric_nr_string: String,
    zzkilomet_string: String,
    zzappnr_obj_string: String,
    zzapprnr_seq_string: String,
    zzapprnr_key_string: String,
    zzcodeexpo_string: String,
    zzlptext_string: String,
    zzplane_string: String,
    zzsmhcd_string: String,
    zzintrt_string: String,
    zzlhcde_string: String,
    zzanldat_string: String,
    zzespdat_string: String,
    zzusr01_string: String,
    zzusr02_string: String,
    zzusr03_string: String,
    zzusr04_string: String,
    zzusr05_string: String,
    zzfiresgnup_string: String,
    zzkdmat_string: String,
    vbrst_string: String,
    zzai_string: String,
    zzminbe_string: String,
    zzmaxbe_string: String,
    zzmelbe_string: String,
    zzfpd_string: String,
    zztgt_string: String,
    zzshp_string: String,
    zchnfe_string: String,
    znre_string: String,
    zndraw_string: String
) extends Entity

object vbap extends TableSpec[Joined[E_vbap_part1, E_vbap_part2]](enableChangeDataFeed = true, manualClusterBy = None, timetravelDays = 35) with Loaded
...
sealed class C_vbap(prefix: String) extends ColumnWithNameAccessor {
  ...
  val zzpoko_string: ColumnWithName = ColumnWithName(prefix + "zzpoko_string")
  val zqgstand_string: ColumnWithName = ColumnWithName(prefix + "zqgstand_string")
  val zzimds_string: ColumnWithName = ColumnWithName(prefix + "zzimds_string")
  val zzsign_string: ColumnWithName = ColumnWithName(prefix + "zzsign_string")
  val zzmatric_nr_string: ColumnWithName = ColumnWithName(prefix + "zzmatric_nr_string")
  val zzkilomet_string: ColumnWithName = ColumnWithName(prefix + "zzkilomet_string")
  val zzappnr_obj_string: ColumnWithName = ColumnWithName(prefix + "zzappnr_obj_string")
  val zzapprnr_seq_string: ColumnWithName = ColumnWithName(prefix + "zzapprnr_seq_string")
  val zzapprnr_key_string: ColumnWithName = ColumnWithName(prefix + "zzapprnr_key_string")
  val zzcodeexpo_string: ColumnWithName = ColumnWithName(prefix + "zzcodeexpo_string")
  val zzlptext_string: ColumnWithName = ColumnWithName(prefix + "zzlptext_string")
  val zzplane_string: ColumnWithName = ColumnWithName(prefix + "zzplane_string")
  val zzsmhcd_string: ColumnWithName = ColumnWithName(prefix + "zzsmhcd_string")
  val zzintrt_string: ColumnWithName = ColumnWithName(prefix + "zzintrt_string")
  val zzlhcde_string: ColumnWithName = ColumnWithName(prefix + "zzlhcde_string")
  val zzanldat_string: ColumnWithName = ColumnWithName(prefix + "zzanldat_string")
  val zzespdat_string: ColumnWithName = ColumnWithName(prefix + "zzespdat_string")
  val zzusr01_string: ColumnWithName = ColumnWithName(prefix + "zzusr01_string")
  val zzusr02_string: ColumnWithName = ColumnWithName(prefix + "zzusr02_string")
  val zzusr03_string: ColumnWithName = ColumnWithName(prefix + "zzusr03_string")
  val zzusr04_string: ColumnWithName = ColumnWithName(prefix + "zzusr04_string")
  val zzusr05_string: ColumnWithName = ColumnWithName(prefix + "zzusr05_string")
  val zzfiresgnup_string: ColumnWithName = ColumnWithName(prefix + "zzfiresgnup_string")
  val zzkdmat_string: ColumnWithName = ColumnWithName(prefix + "zzkdmat_string")
  val vbrst_string: ColumnWithName = ColumnWithName(prefix + "vbrst_string")
  val zzai_string: ColumnWithName = ColumnWithName(prefix + "zzai_string")
  val zzminbe_string: ColumnWithName = ColumnWithName(prefix + "zzminbe_string")
  val zzmaxbe_string: ColumnWithName = ColumnWithName(prefix + "zzmaxbe_string")
  val zzmelbe_string: ColumnWithName = ColumnWithName(prefix + "zzmelbe_string")
  ...
  val zchnfe_string: ColumnWithName = ColumnWithName(prefix + "zchnfe_string")
  val znre_string: ColumnWithName = ColumnWithName(prefix + "znre_string")
  val zndraw_string: ColumnWithName = ColumnWithName(prefix + "zndraw_string")
}
