...
object zmdl_t_lc_loc
    extends TableSpec[E_zmdl_t_lc_loc](
...
sealed class C_zmdl_t_lc_loc(prefix: String) extends ColumnWithNameAccessor {
...
object C_zmdl_t_lc_loc extends C_zmdl_t_lc_loc("") {
  def as(alias: String): C_zmdl_t_lc_loc = new C_zmdl_t_lc_loc(alias + ".")
}
