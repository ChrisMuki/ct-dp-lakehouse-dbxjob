...
case class E_t006j(
    ...
    isotxt_string: String
) extends Entity

object t006j
    extends TableSpec[E_t006j](
...
sealed class C_t006j(prefix: String) extends ColumnWithNameAccessor {
  ...
  val isotxt_string: ColumnWithName = ColumnWithName(prefix + "isotxt_string")
}

object C_t006j extends C_t006j("") {
  def as(alias: String): C_t006j = new C_t006j(alias + ".")
}
