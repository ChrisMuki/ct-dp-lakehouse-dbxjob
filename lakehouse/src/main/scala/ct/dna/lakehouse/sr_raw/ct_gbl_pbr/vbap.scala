...
case class E_vbap_part2(
    ...
    zz_kdkto_string: String,
    zz_2kdmatn_string: String,
    zz_3kdmatn_string: String,
    zz_sdhoriz_string: String,
    zz_mais_kz_string: String,
    zz_edisper_string: String,
    zz_eikto_string: String,
    @Decimal(3, 0) zz_abfftg_decimal_3_0: BigDecimal,
    @Decimal(3, 0) zz_abmftg_decimal_3_0: BigDecimal,
    z_awrnr_string: String,
    zzlandsp_string: String,
    zzedatu_string: String,
...
sealed class C_vbap(prefix: String) extends ColumnWithNameAccessor {
  ...
  val zz_kdkto_string: ColumnWithName = ColumnWithName(prefix + "zz_kdkto_string")
  val zz_2kdmatn_string: ColumnWithName = ColumnWithName(prefix + "zz_2kdmatn_string")
  val zz_3kdmatn_string: ColumnWithName = ColumnWithName(prefix + "zz_3kdmatn_string")
  val zz_sdhoriz_string: ColumnWithName = ColumnWithName(prefix + "zz_sdhoriz_string")
  val zz_mais_kz_string: ColumnWithName = ColumnWithName(prefix + "zz_mais_kz_string")
  val zz_edisper_string: ColumnWithName = ColumnWithName(prefix + "zz_edisper_string")
  val zz_eikto_string: ColumnWithName = ColumnWithName(prefix + "zz_eikto_string")
  val zz_abfftg_decimal_3_0: ColumnWithName = ColumnWithName(prefix + "zz_abfftg_decimal_3_0")
  val zz_abmftg_decimal_3_0: ColumnWithName = ColumnWithName(prefix + "zz_abmftg_decimal_3_0")
  val z_awrnr_string: ColumnWithName = ColumnWithName(prefix + "z_awrnr_string")
  val zzlandsp_string: ColumnWithName = ColumnWithName(prefix + "zzlandsp_string")
  val zzedatu_string: ColumnWithName = ColumnWithName(prefix + "zzedatu_string")
