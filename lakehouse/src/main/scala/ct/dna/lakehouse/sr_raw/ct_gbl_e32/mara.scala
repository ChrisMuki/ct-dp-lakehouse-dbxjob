...
sealed class C_mara(prefix: String) extends ColumnWithNameAccessor {
  ...
  val zz_matnr_neu_string: ColumnWithName = ColumnWithName(prefix + "zz_matnr_neu_string")
  val zz_kdmat_neu_string: ColumnWithName = ColumnWithName(prefix + "zz_kdmat_neu_string")
  val zz_kdmat_txt_neu_string: ColumnWithName = ColumnWithName(prefix + "zz_kdmat_txt_neu_string")
  val zz_zusatztext_string: ColumnWithName = ColumnWithName(prefix + "zz_zusatztext_string")
  val zz_praegung_string: ColumnWithName = ColumnWithName(prefix + "zz_praegung_string")
  val zz_dicke_string: ColumnWithName = ColumnWithName(prefix + "zz_dicke_string")
  val zz_anz_etik_decimal_3_0: ColumnWithName = ColumnWithName(prefix + "zz_anz_etik_decimal_3_0")
  val zz_abrdatum_string: ColumnWithName = ColumnWithName(prefix + "zz_abrdatum_string")
  val zz_konfekt_string: ColumnWithName = ColumnWithName(prefix + "zz_konfekt_string")
  val zz_ernam_etik_string: ColumnWithName = ColumnWithName(prefix + "zz_ernam_etik_string")
  val zz_erdat_etik_string: ColumnWithName = ColumnWithName(prefix + "zz_erdat_etik_string")
  val zz_erzeit_etik_string: ColumnWithName = ColumnWithName(prefix + "zz_erzeit_etik_string")
  val zz_dessin_string: ColumnWithName = ColumnWithName(prefix + "zz_dessin_string")
  val zz_farbe_string: ColumnWithName = ColumnWithName(prefix + "zz_farbe_string")
  val zz_laenge_string: ColumnWithName = ColumnWithName(prefix + "zz_laenge_string")
  val zz_breite_string: ColumnWithName = ColumnWithName(prefix + "zz_breite_string")
  val zz_format_string: ColumnWithName = ColumnWithName(prefix + "zz_format_string")
  val zz_praefix_matnr_string: ColumnWithName = ColumnWithName(prefix + "zz_praefix_matnr_string")
  val zz_hd_vererben_string: ColumnWithName = ColumnWithName(prefix + "zz_hd_vererben_string")
  val zz_desfam_string: ColumnWithName = ColumnWithName(prefix + "zz_desfam_string")
  val zz_konform_string: ColumnWithName = ColumnWithName(prefix + "zz_konform_string")
  val zz_dat_pr_string: ColumnWithName = ColumnWithName(prefix + "zz_dat_pr_string")
  val zz_dat_pvo_string: ColumnWithName = ColumnWithName(prefix + "zz_dat_pvo_string")
