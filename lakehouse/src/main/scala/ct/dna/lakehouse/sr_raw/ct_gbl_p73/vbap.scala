...
case class E_vbap_part2(
    ...
    zzfpd_string: String,
    zztgt_string: String,
    zaltind_string: String,
    zsinco_string: String,
    zport_string: String,
    zzfiresgnup_string: String,
    zconsumo_string: String,
    zzcnum_string: String,
    zzcert_string: String,
    zeinr_string: String,
    zeivr_string: String,
    zzifrs15_itm_string: String,
    zztgt_n_string: String,
    zzfpd_n_string: String,
...
sealed class C_vbap(prefix: String) extends ColumnWithNameAccessor {
  ...
  val zaltind_string: ColumnWithName = ColumnWithName(prefix + "zaltind_string")
  val zsinco_string: ColumnWithName = ColumnWithName(prefix + "zsinco_string")
  val zport_string: ColumnWithName = ColumnWithName(prefix + "zport_string")
  val zzfiresgnup_string: ColumnWithName = ColumnWithName(prefix + "zzfiresgnup_string")
  val zconsumo_string: ColumnWithName = ColumnWithName(prefix + "zconsumo_string")
  val zzcnum_string: ColumnWithName = ColumnWithName(prefix + "zzcnum_string")
  val zzcert_string: ColumnWithName = ColumnWithName(prefix + "zzcert_string")
  ...
  val zztgt_n_string: ColumnWithName = ColumnWithName(prefix + "zztgt_n_string")
  val zzfpd_n_string: ColumnWithName = ColumnWithName(prefix + "zzfpd_n_string")
