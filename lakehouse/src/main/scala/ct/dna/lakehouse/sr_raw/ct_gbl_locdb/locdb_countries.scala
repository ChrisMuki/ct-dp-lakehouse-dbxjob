...
case class E_locdb_countries(
    ...
    language_id_default_string: String,
    country_id_string: String,
    country_name_string: String,
    country_code_string: String
) extends Entity

object locdb_countries
    extends TableSpec[E_locdb_countries](
...
sealed class C_locdb_countries(prefix: String) extends ColumnWithNameAccessor {
  ...
  val language_id_default_string: ColumnWithName = ColumnWithName(prefix + "language_id_default_string")
  val country_id_string: ColumnWithName = ColumnWithName(prefix + "country_id_string")
  val country_name_string: ColumnWithName = ColumnWithName(prefix + "country_name_string")
  val country_code_string: ColumnWithName = ColumnWithName(prefix + "country_code_string")
}

object C_locdb_countries extends C_locdb_countries("") {
  def as(alias: String): C_locdb_countries = new C_locdb_countries(alias + ".")
}
