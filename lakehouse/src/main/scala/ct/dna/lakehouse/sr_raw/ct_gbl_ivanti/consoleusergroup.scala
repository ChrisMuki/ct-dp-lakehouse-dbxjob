...
object consoleusergroup
    extends TableSpec[E_consoleusergroup](
...
sealed class C_consoleusergroup(prefix: String) extends ColumnWithNameAccessor {
  ...
  val consoleusergroup_idn_long: ColumnWithName = ColumnWithName(prefix + "consoleusergroup_idn_long")
  val user_idn_long: ColumnWithName = ColumnWithName(prefix + "user_idn_long")
  val group_idn_long: ColumnWithName = ColumnWithName(prefix + "group_idn_long")
  val contains_masked_personal_data_boolean: ColumnWithName = ColumnWithName(prefix + "contains_masked_personal_data_boolean")
}

object C_consoleusergroup extends C_consoleusergroup("") {
  def as(alias: String): C_consoleusergroup = new C_consoleusergroup(alias + ".")
}
