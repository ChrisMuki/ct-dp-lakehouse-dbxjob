...
case class E_drat(
    ...
    dktxt_string: String,
    ltxin_string: String,
    dktxt_uc_string: String
) extends Entity

object drat
    extends TableSpec[E_drat](
...
sealed class C_drat(prefix: String) extends ColumnWithNameAccessor {
  ...
  val dktxt_string: ColumnWithName = ColumnWithName(prefix + "dktxt_string")
  val ltxin_string: ColumnWithName = ColumnWithName(prefix + "ltxin_string")
  val dktxt_uc_string: ColumnWithName = ColumnWithName(prefix + "dktxt_uc_string")
}

object C_drat extends C_drat("") {
  def as(alias: String): C_drat = new C_drat(alias + ".")
}
