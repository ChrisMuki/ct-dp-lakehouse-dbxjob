...
sealed class C_tcurc(prefix: String) extends ColumnWithNameAccessor {
  ...
  val isocd_string: ColumnWithName = ColumnWithName(prefix + "isocd_string")
  val altwr_string: ColumnWithName = ColumnWithName(prefix + "altwr_string")
  val gdatu_string: ColumnWithName = ColumnWithName(prefix + "gdatu_string")
  val xprimary_string: ColumnWithName = ColumnWithName(prefix + "xprimary_string")
}
