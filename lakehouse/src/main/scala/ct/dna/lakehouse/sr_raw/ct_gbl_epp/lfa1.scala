...
case class E_lfa1(
    ...
    zasn_no_string: String,
    zpref_ord_string: String,
    zchange_order_string: String,
    zariba_enabled_string: String,
...
sealed class C_lfa1(prefix: String) extends ColumnWithNameAccessor {
  ...
  val zasn_no_string: ColumnWithName = ColumnWithName(prefix + "zasn_no_string")
  val zpref_ord_string: ColumnWithName = ColumnWithName(prefix + "zpref_ord_string")
  val zchange_order_string: ColumnWithName = ColumnWithName(prefix + "zchange_order_string")
  val zariba_enabled_string: ColumnWithName = ColumnWithName(prefix + "zariba_enabled_string")
