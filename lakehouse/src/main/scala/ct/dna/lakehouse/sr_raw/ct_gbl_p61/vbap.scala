...
case class E_vbap_part2(
    ...
    zzrdoff_string: String,
    zzausdt_string: String,
    zzauskz_string: String,
    zzvbeln_nach_string: String,
    vbrst_string: String,
    zz901_string: String,
    zz902_string: String,
    zz903_string: String,
    zz904_string: String,
    zsd_recieving_string: String,
    zsd_inspection_string: String,
    zsd_examining_string: String,
    zsd_checking_string: String,
    zsd_booking_string: String,
    zsd_accounting_string: String,
    zsd_inspec_no_string: String,
    zsd_error_code_string: String,
    @Decimal(13, 3) zentqty_decimal_13_3: BigDecimal,
    zentuom_string: String,
...
sealed class C_vbap(prefix: String) extends ColumnWithNameAccessor {
  ...
  val zzrdoff_string: ColumnWithName = ColumnWithName(prefix + "zzrdoff_string")
  val zzausdt_string: ColumnWithName = ColumnWithName(prefix + "zzausdt_string")
  val zzauskz_string: ColumnWithName = ColumnWithName(prefix + "zzauskz_string")
  val zzvbeln_nach_string: ColumnWithName = ColumnWithName(prefix + "zzvbeln_nach_string")
  val vbrst_string: ColumnWithName = ColumnWithName(prefix + "vbrst_string")
  val zz901_string: ColumnWithName = ColumnWithName(prefix + "zz901_string")
  val zz902_string: ColumnWithName = ColumnWithName(prefix + "zz902_string")
  val zz903_string: ColumnWithName = ColumnWithName(prefix + "zz903_string")
  val zz904_string: ColumnWithName = ColumnWithName(prefix + "zz904_string")
  val zsd_recieving_string: ColumnWithName = ColumnWithName(prefix + "zsd_recieving_string")
  val zsd_inspection_string: ColumnWithName = ColumnWithName(prefix + "zsd_inspection_string")
  val zsd_examining_string: ColumnWithName = ColumnWithName(prefix + "zsd_examining_string")
  val zsd_checking_string: ColumnWithName = ColumnWithName(prefix + "zsd_checking_string")
  val zsd_booking_string: ColumnWithName = ColumnWithName(prefix + "zsd_booking_string")
  val zsd_accounting_string: ColumnWithName = ColumnWithName(prefix + "zsd_accounting_string")
  val zsd_inspec_no_string: ColumnWithName = ColumnWithName(prefix + "zsd_inspec_no_string")
  val zsd_error_code_string: ColumnWithName = ColumnWithName(prefix + "zsd_error_code_string")
  val zentqty_decimal_13_3: ColumnWithName = ColumnWithName(prefix + "zentqty_decimal_13_3")
  val zentuom_string: ColumnWithName = ColumnWithName(prefix + "zentuom_string")
