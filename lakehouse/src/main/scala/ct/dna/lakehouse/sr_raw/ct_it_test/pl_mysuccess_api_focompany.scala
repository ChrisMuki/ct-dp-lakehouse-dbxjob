...
@LakehouseEntity
case class pl_mysuccess_api_focompany_E(
  @PK _mk_org: String,
  @PK _mk_site: String,
  ...
  cust_officiallanguage_string: String,
  name_en_us_string: String,
  name_de_de_string: String,
  name_fr_fr_string: String
) extends Entity

object pl_mysuccess_api_focompany extends TableSpec[pl_mysuccess_api_focompany_E](
