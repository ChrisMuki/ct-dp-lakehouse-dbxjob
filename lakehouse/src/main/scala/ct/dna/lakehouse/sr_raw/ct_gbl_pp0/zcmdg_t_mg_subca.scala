...
case class E_zcmdg_t_mg_subca(
    ...
    mandt_string: String,
    cpmg_subcategory_string: String,
    cpmg_subcategoryt_string: String
) extends Entity

object zcmdg_t_mg_subca
    extends TableSpec[E_zcmdg_t_mg_subca](
...
sealed class C_zcmdg_t_mg_subca(prefix: String) extends ColumnWithNameAccessor {
  ...
  val cpmg_subcategory_string: ColumnWithName = ColumnWithName(prefix + "cpmg_subcategory_string")
  val cpmg_subcategoryt_string: ColumnWithName = ColumnWithName(prefix + "cpmg_subcategoryt_string")
}

object C_zcmdg_t_mg_subca extends C_zcmdg_t_mg_subca("") {
  def as(alias: String): C_zcmdg_t_mg_subca = new C_zcmdg_t_mg_subca(alias + ".")
}
