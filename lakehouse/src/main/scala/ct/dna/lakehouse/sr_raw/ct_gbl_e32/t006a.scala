...
sealed class C_t006a(prefix: String) extends ColumnWithNameAccessor {
  ...
  val mseh3_string: ColumnWithName = ColumnWithName(prefix + "mseh3_string")
  val mseh6_string: ColumnWithName = ColumnWithName(prefix + "mseh6_string")
  val mseht_string: ColumnWithName = ColumnWithName(prefix + "mseht_string")
  val msehl_string: ColumnWithName = ColumnWithName(prefix + "msehl_string")
}
