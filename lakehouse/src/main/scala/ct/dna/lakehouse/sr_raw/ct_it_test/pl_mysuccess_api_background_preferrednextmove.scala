...
@LakehouseEntity
case class pl_mysuccess_api_background_preferrednextmove_E(
  @PK _mk_org: String,
  @PK _mk_site: String,
...
object pl_mysuccess_api_background_preferrednextmove extends TableSpec[pl_mysuccess_api_background_preferrednextmove_E](
