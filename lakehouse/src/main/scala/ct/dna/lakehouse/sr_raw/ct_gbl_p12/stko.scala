...
sealed class C_stko(prefix: String) extends ColumnWithNameAccessor {
  ...
  val zzkunde_string: ColumnWithName = ColumnWithName(prefix + "zzkunde_string")
  val zzfertv_string: ColumnWithName = ColumnWithName(prefix + "zzfertv_string")
  val zzindex_string: ColumnWithName = ColumnWithName(prefix + "zzindex_string")
  val zzstand_string: ColumnWithName = ColumnWithName(prefix + "zzstand_string")
  val zzaenr_string: ColumnWithName = ColumnWithName(prefix + "zzaenr_string")
  val zzeco_string: ColumnWithName = ColumnWithName(prefix + "zzeco_string")
  val zzkennz_string: ColumnWithName = ColumnWithName(prefix + "zzkennz_string")
  val zzkindex_string: ColumnWithName = ColumnWithName(prefix + "zzkindex_string")
  val zznorm_string: ColumnWithName = ColumnWithName(prefix + "zznorm_string")
  val zztemp_string: ColumnWithName = ColumnWithName(prefix + "zztemp_string")
  val zzzeit_string: ColumnWithName = ColumnWithName(prefix + "zzzeit_string")
  val zzgewicht_decimal_13_3: ColumnWithName = ColumnWithName(prefix + "zzgewicht_decimal_13_3")
  val zzmeins_string: ColumnWithName = ColumnWithName(prefix + "zzmeins_string")
  val zserst_string: ColumnWithName = ColumnWithName(prefix + "zserst_string")
}
