...
case class E_locdb_responsible_roles(
    @PK _mk_org: String,
    @PK _mk_site: String,
    ...
    responsible_role_name_string: String,
    responsible_role_id_string: String,
    needs_review_string: String
) extends Entity

object locdb_responsible_roles
    extends TableSpec[E_locdb_responsible_roles](
...
sealed class C_locdb_responsible_roles(prefix: String) extends ColumnWithNameAccessor {
  ...
  val responsible_role_name_string: ColumnWithName = ColumnWithName(prefix + "responsible_role_name_string")
  val responsible_role_id_string: ColumnWithName = ColumnWithName(prefix + "responsible_role_id_string")
  val needs_review_string: ColumnWithName = ColumnWithName(prefix + "needs_review_string")
}

object C_locdb_responsible_roles extends C_locdb_responsible_roles("") {
  def as(alias: String): C_locdb_responsible_roles = new C_locdb_responsible_roles(alias + ".")
}
