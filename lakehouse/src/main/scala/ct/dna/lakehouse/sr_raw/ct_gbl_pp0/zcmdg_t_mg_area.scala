...
object zcmdg_t_mg_area
    extends TableSpec[E_zcmdg_t_mg_area](
...
sealed class C_zcmdg_t_mg_area(prefix: String) extends ColumnWithNameAccessor {
  ...
  val areat_string: ColumnWithName = ColumnWithName(prefix + "areat_string")
}

object C_zcmdg_t_mg_area extends C_zcmdg_t_mg_area("") {
  def as(alias: String): C_zcmdg_t_mg_area = new C_zcmdg_t_mg_area(alias + ".")
}
