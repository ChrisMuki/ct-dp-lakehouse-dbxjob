...
case class E_plaf(
    ...
    org_req_date_string: String,
    ptext_string: String,
    dummy_plaf_incl_eew_ps_string: String,
    medkz_string: String,
    ...
    atrkz_string: String,
    @Decimal(15, 0) dps_handover_time_decimal_15_0: BigDecimal,
    zzpool_guid_string: String
) extends Entity
...
sealed class C_plaf(prefix: String) extends ColumnWithNameAccessor {
  ...
  val org_req_date_string: ColumnWithName = ColumnWithName(prefix + "org_req_date_string")
  val ptext_string: ColumnWithName = ColumnWithName(prefix + "ptext_string")
  val dummy_plaf_incl_eew_ps_string: ColumnWithName = ColumnWithName(prefix + "dummy_plaf_incl_eew_ps_string")
  ...
  val bom_versn_string: ColumnWithName = ColumnWithName(prefix + "bom_versn_string")
  ...
  val dps_handover_time_decimal_15_0: ColumnWithName = ColumnWithName(prefix + "dps_handover_time_decimal_15_0")
  val zzpool_guid_string: ColumnWithName = ColumnWithName(prefix + "zzpool_guid_string")
}
