...
object zmdl_t_mc_vnd
    extends TableSpec[E_zmdl_t_mc_vnd](
...
sealed class C_zmdl_t_mc_vnd(prefix: String) extends ColumnWithNameAccessor {
...
object C_zmdl_t_mc_vnd extends C_zmdl_t_mc_vnd("") {
  def as(alias: String): C_zmdl_t_mc_vnd = new C_zmdl_t_mc_vnd(alias + ".")
}
