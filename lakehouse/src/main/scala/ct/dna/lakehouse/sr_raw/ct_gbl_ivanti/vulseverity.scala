...
case class E_vulseverity(
    ...
    vulseverity_idn_long: BoxedLong,
    severity_id_long: BoxedLong,
    displayname_string: String,
    contains_masked_personal_data_boolean: BoxedBoolean
) extends Entity

object vulseverity
    extends TableSpec[E_vulseverity](
...
sealed class C_vulseverity(prefix: String) extends ColumnWithNameAccessor {
  ...
  val vulseverity_idn_long: ColumnWithName = ColumnWithName(prefix + "vulseverity_idn_long")
  val severity_id_long: ColumnWithName = ColumnWithName(prefix + "severity_id_long")
...
object C_vulseverity extends C_vulseverity("") {
  def as(alias: String): C_vulseverity = new C_vulseverity(alias + ".")
}
