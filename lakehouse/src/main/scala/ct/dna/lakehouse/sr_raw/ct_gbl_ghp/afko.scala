...
case class E_afko(
    ...
    flexible_processing_string: String,
    extended_quality_checks_string: String,
    adpsp_string: String,
    rmanr_string: String,
...
sealed class C_afko(prefix: String) extends ColumnWithNameAccessor {
  ...
  val flexible_processing_string: ColumnWithName = ColumnWithName(prefix + "flexible_processing_string")
  val extended_quality_checks_string: ColumnWithName = ColumnWithName(prefix + "extended_quality_checks_string")
