...
case class E_plpo_part1(
    ...
    dummy_plpo_incl_eew_ps_string: String,
    tplnr_string: String,
    equnr_string: String,
    ...
    versn_source_plnkn_string: String,
    versn_track_guid_binary: Array[Byte],
    fav_guid_string: String,
    fav_versn_string: String,
    fav_guid_old_string: String,
    fav_versn_old_string: String,
    cl_type_string: String,
    execution_stage_string: String,
...
sealed class C_plpo(prefix: String) extends ColumnWithNameAccessor {
  ...
  val dummy_plpo_incl_eew_ps_string: ColumnWithName = ColumnWithName(prefix + "dummy_plpo_incl_eew_ps_string")
  ...
  val versn_source_plnkn_string: ColumnWithName = ColumnWithName(prefix + "versn_source_plnkn_string")
  val versn_track_guid_binary: ColumnWithName = ColumnWithName(prefix + "versn_track_guid_binary")
  val fav_guid_string: ColumnWithName = ColumnWithName(prefix + "fav_guid_string")
  val fav_versn_string: ColumnWithName = ColumnWithName(prefix + "fav_versn_string")
  val fav_guid_old_string: ColumnWithName = ColumnWithName(prefix + "fav_guid_old_string")
  val fav_versn_old_string: ColumnWithName = ColumnWithName(prefix + "fav_versn_old_string")
  val cl_type_string: ColumnWithName = ColumnWithName(prefix + "cl_type_string")
  val execution_stage_string: ColumnWithName = ColumnWithName(prefix + "execution_stage_string")
