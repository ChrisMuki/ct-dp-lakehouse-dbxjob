...
sealed class C_tj02t(prefix: String) extends ColumnWithNameAccessor {
  ...
  val istat_string: ColumnWithName = ColumnWithName(prefix + "istat_string")
  val spras_string: ColumnWithName = ColumnWithName(prefix + "spras_string")
  val txt04_string: ColumnWithName = ColumnWithName(prefix + "txt04_string")
  val txt30_string: ColumnWithName = ColumnWithName(prefix + "txt30_string")
}
