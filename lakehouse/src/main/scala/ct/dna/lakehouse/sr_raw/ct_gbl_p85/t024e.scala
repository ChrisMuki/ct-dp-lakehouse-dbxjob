...
case class E_t024e(
    ...
    zzcontilogo_string: String,
    zzconti_szg_string: String
) extends Entity
...
sealed class C_t024e(prefix: String) extends ColumnWithNameAccessor {
  ...
  val zzcontilogo_string: ColumnWithName = ColumnWithName(prefix + "zzcontilogo_string")
  val zzconti_szg_string: ColumnWithName = ColumnWithName(prefix + "zzconti_szg_string")
}
