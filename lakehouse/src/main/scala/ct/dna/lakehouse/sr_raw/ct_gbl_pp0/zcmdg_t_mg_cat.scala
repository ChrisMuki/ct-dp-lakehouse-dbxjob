...
case class E_zcmdg_t_mg_cat(
    ...
    mandt_string: String,
    cpmg_category_string: String,
    cpmg_categoryt_string: String
) extends Entity

object zcmdg_t_mg_cat
    extends TableSpec[E_zcmdg_t_mg_cat](
...
sealed class C_zcmdg_t_mg_cat(prefix: String) extends ColumnWithNameAccessor {
  ...
  val cpmg_category_string: ColumnWithName = ColumnWithName(prefix + "cpmg_category_string")
  val cpmg_categoryt_string: ColumnWithName = ColumnWithName(prefix + "cpmg_categoryt_string")
}

object C_zcmdg_t_mg_cat extends C_zcmdg_t_mg_cat("") {
  def as(alias: String): C_zcmdg_t_mg_cat = new C_zcmdg_t_mg_cat(alias + ".")
}
