...
sealed class C_knmt(prefix: String) extends ColumnWithNameAccessor {
  ...
  val zm_herst_string: ColumnWithName = ColumnWithName(prefix + "zm_herst_string")
  val zm_breihe_string: ColumnWithName = ColumnWithName(prefix + "zm_breihe_string")
  val zm_modell_string: ColumnWithName = ColumnWithName(prefix + "zm_modell_string")
  val zm_teil_string: ColumnWithName = ColumnWithName(prefix + "zm_teil_string")
}
