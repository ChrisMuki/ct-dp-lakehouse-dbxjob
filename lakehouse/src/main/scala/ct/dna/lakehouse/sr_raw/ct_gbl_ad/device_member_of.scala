...
object device_member_of
    extends TableSpec[E_device_member_of](
...
sealed class C_device_member_of(prefix: String) extends ColumnWithNameAccessor {
...
object C_device_member_of extends C_device_member_of("") {
  def as(alias: String): C_device_member_of = new C_device_member_of(alias + ".")
}
