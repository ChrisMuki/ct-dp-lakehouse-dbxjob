...
case class E_vbpa(
    ...
    hzuor_string: String,
    stceg_string: String,
    parvw_ff_string: String,
    adrnp_string: String,
    kale_string: String,
    _dataaging_string: String,
    assigned_bp_string: String,
    addr_operation_string: String,
    addr_type_string: String,
    bp_ref_adrnr_string: String,
    dummy_sddocpartner_incl_eew_ps_string: String,
...
sealed class C_vbpa(prefix: String) extends ColumnWithNameAccessor {
  ...
  val parvw_ff_string: ColumnWithName = ColumnWithName(prefix + "parvw_ff_string")
  val adrnp_string: ColumnWithName = ColumnWithName(prefix + "adrnp_string")
  val kale_string: ColumnWithName = ColumnWithName(prefix + "kale_string")
  val _dataaging_string: ColumnWithName = ColumnWithName(prefix + "_dataaging_string")
  val assigned_bp_string: ColumnWithName = ColumnWithName(prefix + "assigned_bp_string")
  val addr_operation_string: ColumnWithName = ColumnWithName(prefix + "addr_operation_string")
  val addr_type_string: ColumnWithName = ColumnWithName(prefix + "addr_type_string")
  val bp_ref_adrnr_string: ColumnWithName = ColumnWithName(prefix + "bp_ref_adrnr_string")
  val dummy_sddocpartner_incl_eew_ps_string: ColumnWithName = ColumnWithName(prefix + "dummy_sddocpartner_incl_eew_ps_string")
