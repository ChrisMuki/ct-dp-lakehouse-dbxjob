...
@LakehouseEntity
case class pl_mysuccess_api_cust_functionalarea_E(
  @PK _mk_org: String,
  @PK _mk_site: String,
  ...
  externalname_string: String,
  mdfsystemlastmodifieddate_string: String,
  lastmodifieddatetime_string: String
) extends Entity

object pl_mysuccess_api_cust_functionalarea extends TableSpec[pl_mysuccess_api_cust_functionalarea_E](
