...
case class E_zcmdg_t_mg_clus(
    ...
    mandt_string: String,
    cpmg_cluster_string: String,
    cpmg_clustert_string: String
) extends Entity

object zcmdg_t_mg_clus
    extends TableSpec[E_zcmdg_t_mg_clus](
...
sealed class C_zcmdg_t_mg_clus(prefix: String) extends ColumnWithNameAccessor {
  ...
  val cpmg_cluster_string: ColumnWithName = ColumnWithName(prefix + "cpmg_cluster_string")
  val cpmg_clustert_string: ColumnWithName = ColumnWithName(prefix + "cpmg_clustert_string")
}

object C_zcmdg_t_mg_clus extends C_zcmdg_t_mg_clus("") {
  def as(alias: String): C_zcmdg_t_mg_clus = new C_zcmdg_t_mg_clus(alias + ".")
}
