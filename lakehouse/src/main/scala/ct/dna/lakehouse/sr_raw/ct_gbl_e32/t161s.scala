...
case class E_t161s(
    ...
    flref_string: String,
    kzfae_string: String,
    @Decimal(4, 1) tlfae_decimal_4_1: BigDecimal
) extends Entity
...
sealed class C_t161s(prefix: String) extends ColumnWithNameAccessor {
  ...
  val fixbp_string: ColumnWithName = ColumnWithName(prefix + "fixbp_string")
  val frang_string: ColumnWithName = ColumnWithName(prefix + "frang_string")
  val frbst_string: ColumnWithName = ColumnWithName(prefix + "frbst_string")
  val flref_string: ColumnWithName = ColumnWithName(prefix + "flref_string")
  val kzfae_string: ColumnWithName = ColumnWithName(prefix + "kzfae_string")
  val tlfae_decimal_4_1: ColumnWithName = ColumnWithName(prefix + "tlfae_decimal_4_1")
}
