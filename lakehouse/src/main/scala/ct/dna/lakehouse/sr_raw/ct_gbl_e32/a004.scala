...
sealed class C_a004(prefix: String) extends ColumnWithNameAccessor {
...
object C_a004 extends C_a004("") {
  def as(alias: String): C_a004 = new C_a004(alias + ".")
}
