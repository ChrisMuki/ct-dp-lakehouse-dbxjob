...
case class E_knbk(
    ...
    tech_rectyp_string: String,
    ebpp_accname_string: String,
    ebpp_bvstatus_string: String,
    kovon_string: String,
    kobis_string: String,
    zbukrs_string: String,
    zrole_string: String,
    zwaers_string: String
) extends Entity
...
sealed class C_knbk(prefix: String) extends ColumnWithNameAccessor {
  ...
  val tech_rectyp_string: ColumnWithName = ColumnWithName(prefix + "tech_rectyp_string")
  ...
  val zbukrs_string: ColumnWithName = ColumnWithName(prefix + "zbukrs_string")
  val zrole_string: ColumnWithName = ColumnWithName(prefix + "zrole_string")
  val zwaers_string: ColumnWithName = ColumnWithName(prefix + "zwaers_string")
}
