...
object rbkp extends TableSpec[E_rbkp](enableChangeDataFeed = true, manualClusterBy = None, timetravelDays = 35) with Loaded
...
sealed class C_rbkp(prefix: String) extends ColumnWithNameAccessor {
  ...
  val glo_re1_ot_string: ColumnWithName = ColumnWithName(prefix + "glo_re1_ot_string")
