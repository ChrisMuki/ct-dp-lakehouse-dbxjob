...
case class E_pl_mysuccess_api_picklistv2(
    @PK _mk_org: String,
    @PK _mk_site: String,
...
object pl_mysuccess_api_picklistv2
    extends TableSpec[E_pl_mysuccess_api_picklistv2](
...
sealed class C_pl_mysuccess_api_picklistv2(prefix: String) extends ColumnWithNameAccessor {
  ...
  val label_localized_string: ColumnWithName = ColumnWithName(prefix + "label_localized_string")
  val optionid_string: ColumnWithName = ColumnWithName(prefix + "optionid_string")
  val contains_masked_personal_data_boolean: ColumnWithName = ColumnWithName(prefix + "contains_masked_personal_data_boolean")
}

object C_pl_mysuccess_api_picklistv2 extends C_pl_mysuccess_api_picklistv2("") {
  def as(alias: String): C_pl_mysuccess_api_picklistv2 = new C_pl_mysuccess_api_picklistv2(alias + ".")
}
