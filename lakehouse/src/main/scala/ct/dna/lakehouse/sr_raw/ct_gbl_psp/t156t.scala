...
case class E_t156t(
    ...
    kzvbr_string: String,
    btext_string: String,
    btext_esh_string: String,
    btext_l_string: String
) extends Entity
...
sealed class C_t156t(prefix: String) extends ColumnWithNameAccessor {
  ...
  val btext_esh_string: ColumnWithName = ColumnWithName(prefix + "btext_esh_string")
  val btext_l_string: ColumnWithName = ColumnWithName(prefix + "btext_l_string")
}
