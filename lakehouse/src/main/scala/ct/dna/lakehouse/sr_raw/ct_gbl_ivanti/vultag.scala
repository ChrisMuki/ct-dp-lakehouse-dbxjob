...
sealed class C_vultag(prefix: String) extends ColumnWithNameAccessor {
...
object C_vultag extends C_vultag("") {
  def as(alias: String): C_vultag = new C_vultag(alias + ".")
}
