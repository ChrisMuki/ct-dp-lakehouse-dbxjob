...
case class E_eban(
    ...
    expert_mode_string: String,
    storenetworkid_string: String,
    storesupplierid_string: String,
    creationdate_string: String,
    creationtime_string: String,
    iscrreplicationbeforeapproval_string: String,
    mmpur_pr_cen_reqn_app_rpld_pr_string: String,
    ...
    yysent_string: String,
    yydate_string: String,
    yytime_string: String
) extends Entity

object eban extends TableSpec[E_eban](enableChangeDataFeed = true, manualClusterBy = None, timetravelDays = 35) with Loaded
...
sealed class C_eban(prefix: String) extends ColumnWithNameAccessor {
  ...
  val expert_mode_string: ColumnWithName = ColumnWithName(prefix + "expert_mode_string")
  ...
  val iscrreplicationbeforeapproval_string: ColumnWithName = ColumnWithName(prefix + "iscrreplicationbeforeapproval_string")
  val mmpur_pr_cen_reqn_app_rpld_pr_string: ColumnWithName = ColumnWithName(prefix + "mmpur_pr_cen_reqn_app_rpld_pr_string")
  ...
  val yysent_string: ColumnWithName = ColumnWithName(prefix + "yysent_string")
  val yydate_string: ColumnWithName = ColumnWithName(prefix + "yydate_string")
  val yytime_string: ColumnWithName = ColumnWithName(prefix + "yytime_string")
}
