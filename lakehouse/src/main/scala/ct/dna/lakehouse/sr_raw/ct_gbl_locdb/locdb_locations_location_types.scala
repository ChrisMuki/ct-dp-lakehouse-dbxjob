...
case class E_locdb_locations_location_types(
    @PK _mk_org: String,
    @PK _mk_site: String,
    ...
    location_type_id_string: String
) extends Entity

object locdb_locations_location_types
    extends TableSpec[E_locdb_locations_location_types](
...
sealed class C_locdb_locations_location_types(prefix: String) extends ColumnWithNameAccessor {
  ...
  val location_type_id_string: ColumnWithName = ColumnWithName(prefix + "location_type_id_string")
}

object C_locdb_locations_location_types extends C_locdb_locations_location_types("") {
  def as(alias: String): C_locdb_locations_location_types = new C_locdb_locations_location_types(alias + ".")
}
