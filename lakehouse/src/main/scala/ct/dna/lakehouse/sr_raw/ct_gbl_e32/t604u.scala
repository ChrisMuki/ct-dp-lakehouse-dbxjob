...
case class E_t604u(
    ...
    mandt_string: String,
    aland_string: String,
    stawn_exp_string: String,
    lland_string: String,
    stawn_imp_string: String,
    vumko_string: String
) extends Entity
...
sealed class C_t604u(prefix: String) extends ColumnWithNameAccessor {
  ...
  val stawn_exp_string: ColumnWithName = ColumnWithName(prefix + "stawn_exp_string")
  val lland_string: ColumnWithName = ColumnWithName(prefix + "lland_string")
  val stawn_imp_string: ColumnWithName = ColumnWithName(prefix + "stawn_imp_string")
  val vumko_string: ColumnWithName = ColumnWithName(prefix + "vumko_string")
}
