...
case class pl_smartrecruiters_aihcr_job_details_1_E(
    ...
    number_of_positions_in_status_open_string: String,
    replacement_for_string: String,
    needed_by_dd_mm_yyyy_string: String,
    ...
    special_treatment_string: String,
