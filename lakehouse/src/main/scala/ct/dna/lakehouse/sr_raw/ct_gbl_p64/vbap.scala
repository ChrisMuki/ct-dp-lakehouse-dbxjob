...
case class E_vbap_part2(
    ...
    zifrs1_string: String,
    zifrs2_string: String,
...
sealed class C_vbap(prefix: String) extends ColumnWithNameAccessor {
  ...
  val zifrs1_string: ColumnWithName = ColumnWithName(prefix + "zifrs1_string")
  val zifrs2_string: ColumnWithName = ColumnWithName(prefix + "zifrs2_string")
