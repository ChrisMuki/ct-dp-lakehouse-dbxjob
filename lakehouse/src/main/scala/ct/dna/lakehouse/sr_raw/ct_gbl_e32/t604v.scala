...
case class E_t604v(
    ...
    xpw_string: String,
    xopw_string: String,
    xdrittl_string: String,
    xeu_string: String,
    xhspos_string: String
) extends Entity
...
sealed class C_t604v(prefix: String) extends ColumnWithNameAccessor {
  ...
  val verfa_string: ColumnWithName = ColumnWithName(prefix + "verfa_string")
  val xpw_string: ColumnWithName = ColumnWithName(prefix + "xpw_string")
  val xopw_string: ColumnWithName = ColumnWithName(prefix + "xopw_string")
  val xdrittl_string: ColumnWithName = ColumnWithName(prefix + "xdrittl_string")
  val xeu_string: ColumnWithName = ColumnWithName(prefix + "xeu_string")
  val xhspos_string: ColumnWithName = ColumnWithName(prefix + "xhspos_string")
}
