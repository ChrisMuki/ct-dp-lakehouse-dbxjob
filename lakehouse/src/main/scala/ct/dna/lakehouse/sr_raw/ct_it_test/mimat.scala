...
case class mimat_E(
    ...
    value_zeitpkt_string: String,
    meta_source_change_lsn_string: String,
    value_toleranz_string: String,
    value_temperierungsoll_long: BoxedLong,
    value_beutelk_string: String,
    value_codenr_string: String,
    meta_source_db_string: String,
    meta_source_ts_us_long: BoxedLong,
    value_name_string: String,
    value_gewicht_string: String,
    value_eingabeart_long: BoxedLong,
    ...
    value_parwechselbunker_long: BoxedLong,
    value_silonr_long: BoxedLong,
    key_twerkst_string: String,
    value_waagennr_long: BoxedLong,
    meta_source_schema_string: String,
    key_matnr_long: BoxedLong
) extends Entity

object mimat
    extends TableSpec[mimat_E](
