...
sealed class C_uscompany(prefix: String) extends ColumnWithNameAccessor {
...
object C_uscompany extends C_uscompany("") {
  def as(alias: String): C_uscompany = new C_uscompany(alias + ".")
}
