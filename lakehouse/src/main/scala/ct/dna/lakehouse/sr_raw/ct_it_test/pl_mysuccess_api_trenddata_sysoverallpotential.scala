...
@LakehouseEntity
case class pl_mysuccess_api_trenddata_sysoverallpotential_E(
  @PK _mk_org: String,
  @PK _mk_site: String,
...
object pl_mysuccess_api_trenddata_sysoverallpotential extends TableSpec[pl_mysuccess_api_trenddata_sysoverallpotential_E](
