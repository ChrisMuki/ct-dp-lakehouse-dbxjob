...
case class E_chr_job_hiring_team(
    @PK _mk_org: String,
    @PK _mk_site: String,
    ...
    hiring_team_member_employee_id_string: String,
    hiring_team_role_string: String,
    job_id_string: String
) extends Entity

object chr_job_hiring_team
    extends TableSpec[E_chr_job_hiring_team](
...
sealed class C_chr_job_hiring_team(prefix: String) extends ColumnWithNameAccessor {
  ...
  val hiring_team_member_employee_id_string: ColumnWithName = ColumnWithName(prefix + "hiring_team_member_employee_id_string")
  val hiring_team_role_string: ColumnWithName = ColumnWithName(prefix + "hiring_team_role_string")
  val job_id_string: ColumnWithName = ColumnWithName(prefix + "job_id_string")
}

object C_chr_job_hiring_team extends C_chr_job_hiring_team("") {
  def as(alias: String): C_chr_job_hiring_team = new C_chr_job_hiring_team(alias + ".")
}
