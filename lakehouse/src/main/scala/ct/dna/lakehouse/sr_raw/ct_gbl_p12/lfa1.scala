...
case class E_lfa1(
    ...
    zsvgr_string: String,
    zzumsys_string: String,
    zzumsysdat_string: String
) extends Entity
...
sealed class C_lfa1(prefix: String) extends ColumnWithNameAccessor {
  ...
  val zzumsys_string: ColumnWithName = ColumnWithName(prefix + "zzumsys_string")
  val zzumsysdat_string: ColumnWithName = ColumnWithName(prefix + "zzumsysdat_string")
}
