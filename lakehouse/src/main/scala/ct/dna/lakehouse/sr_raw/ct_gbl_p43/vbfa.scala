...
case class E_vbfa(
    ...
    cmeth_string: String,
    mjahr_string: String,
    vbtypext_v_string: String,
    vbtypext_n_string: String
) extends Entity
...
sealed class C_vbfa(prefix: String) extends ColumnWithNameAccessor {
  ...
  val vbtypext_v_string: ColumnWithName = ColumnWithName(prefix + "vbtypext_v_string")
  val vbtypext_n_string: ColumnWithName = ColumnWithName(prefix + "vbtypext_n_string")
}
