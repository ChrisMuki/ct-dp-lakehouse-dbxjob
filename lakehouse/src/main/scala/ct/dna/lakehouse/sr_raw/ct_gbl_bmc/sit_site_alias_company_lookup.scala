...
case class E_sit_site_alias_company_lookup(
    @PK _mk_org: String,
    @PK _mk_site: String,
...
object sit_site_alias_company_lookup
    extends TableSpec[E_sit_site_alias_company_lookup](
...
sealed class C_sit_site_alias_company_lookup(prefix: String) extends ColumnWithNameAccessor {
...
object C_sit_site_alias_company_lookup extends C_sit_site_alias_company_lookup("") {
  def as(alias: String): C_sit_site_alias_company_lookup = new C_sit_site_alias_company_lookup(alias + ".")
}
